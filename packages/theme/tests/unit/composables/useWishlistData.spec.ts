...
describe('[bigcommerce-theme] useProductData', () => {
  ...
  describe('[bigcommerce-theme] useProductData getItems', () => {
    it('should return array of items', () => {
      expect(wishlistData.getItems(wishlistMock as Wishlist)).toStrictEqual(wishlistMock.items);
    });
  });
  ...
  describe('[bigcommerce-theme] useProductData getItemName', () => {
    it('should return product name', () => {
      expect(wishlistData.getItemName(wishlistMock as Wishlist, wishlistItem)).toBe(mockedProduct.name);
    });
  });

  describe('[bigcommerce-theme] useProductData getItemImage', () => {
    it('should return product cover image', () => {
      const expectedImage = 'https://cdn11.bigcommerce.com/s-moq5tdn0k6/products/77/images/266/foglinenbeigestripetowel1b.1633499289.386.513.jpg?c=1';
      expect(wishlistData.getItemImage(wishlistMock as Wishlist, wishlistItem)).toBe(expectedImage);
    });
  });
  ...
  describe('[bigcommerce-theme] useProductData getItemPrice', () => {
    it('should return product price', () => {
      ...
      expect(wishlistData.getItemPrice(wishlistMock as Wishlist, wishlistItem)).toStrictEqual(expectedPrice);
    });
  });

  describe('[bigcommerce-theme] useProductData getItemSku', () => {
    it('should return product sku', () => {
      expect(wishlistData.getItemSku(wishlistMock as Wishlist, wishlistItem)).toBe(mockedProduct.sku);
    });
  });
