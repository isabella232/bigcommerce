  ...
  <div>
    ...
    <SfTable class="sf-table--bordered table desktop-only">
      ...
      >
        ...
        <SfTableData
          class="table__data"
          v-for="(value, key) in cartData.getItemAttributes(product)"
          :key="key"
        >
          {{ value }}
        </SfTableData>
        ...
        <SfTableData class="table__data price">
          <SfPrice
            :regular="$n(cartData.getItemPrice(product).regular, 'currency')"
            :special="
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    return {
      ...
      terms,
      loading,
      products: computed(() => cartData.getItems(cart.value)),
      totals: computed(() => cartData.getTotals(cart.value)),
