...
export function CustomerFullAllOfFromJSON(json: any): CustomerFullAllOf {
    return CustomerFullAllOfFromJSONTyped(json, false);
}

export function CustomerFullAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomerFullAllOf {
...
export function CustomerFullAllOfToJSON(value?: CustomerFullAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
