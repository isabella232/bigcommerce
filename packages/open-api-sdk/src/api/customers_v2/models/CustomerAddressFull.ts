...
import {
    ...
    CustomerAddressBaseFromJSONTyped,
    CustomerAddressBaseToJSON,
    CustomerAddressFullAllOf,
    CustomerAddressFullAllOfFromJSON,
    CustomerAddressFullAllOfFromJSONTyped,
    CustomerAddressFullAllOfToJSON,
} from './';
 ...
 */
export interface CustomerAddressFull {
    /**
     * ID of this customer address. READ-ONLY
     * @type {number}
     * @memberof CustomerAddressFull
     */
    id?: number;
    /**
     ...
     * @memberof CustomerAddressFull
     */
    addressType?: CustomerAddressFullAddressTypeEnum;
}
...
* @enum {string}
*/
export enum CustomerAddressFullAddressTypeEnum {
    Residential = 'residential',
    Commercial = 'commercial'
}

export function CustomerAddressFullFromJSON(json: any): CustomerAddressFull {
    return CustomerAddressFullFromJSONTyped(json, false);
}

export function CustomerAddressFullFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomerAddressFull {
...
export function CustomerAddressFullToJSON(value?: CustomerAddressFull | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
