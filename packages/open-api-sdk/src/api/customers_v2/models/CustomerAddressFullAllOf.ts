 ...
 * 
 * @export
 * @interface CustomerAddressFullAllOf
 */
export interface CustomerAddressFullAllOf {
    /**
     * ID of this customer address. READ-ONLY
     * @type {number}
     * @memberof CustomerAddressFullAllOf
     */
    id?: number;
    /**
...
export function CustomerAddressFullAllOfFromJSON(json: any): CustomerAddressFullAllOf {
    return CustomerAddressFullAllOfFromJSONTyped(json, false);
}

export function CustomerAddressFullAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomerAddressFullAllOf {
...
export function CustomerAddressFullAllOfToJSON(value?: CustomerAddressFullAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
