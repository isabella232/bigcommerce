 ...
 * 
 * @export
 * @interface CategoryAccessLevelFull
 */
export interface CategoryAccessLevelFull {
    /**
     ...
     * @type {string}
     * @memberof CategoryAccessLevelFull
     */
    type?: CategoryAccessLevelFullTypeEnum;
    /**
...
* @enum {string}
*/
export enum CategoryAccessLevelFullTypeEnum {
    All = 'all',
    Specific = 'specific',
    None = 'none'
}

export function CategoryAccessLevelFullFromJSON(json: any): CategoryAccessLevelFull {
    return CategoryAccessLevelFullFromJSONTyped(json, false);
}

export function CategoryAccessLevelFullFromJSONTyped(json: any, ignoreDiscriminator: boolean): CategoryAccessLevelFull {
...
export function CategoryAccessLevelFullToJSON(value?: CategoryAccessLevelFull | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
