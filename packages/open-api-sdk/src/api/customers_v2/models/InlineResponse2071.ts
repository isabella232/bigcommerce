 ...
 * 
 * @export
 * @interface InlineResponse2071
 */
export interface InlineResponse2071 {
    /**
     * 
     * @type {number}
     * @memberof InlineResponse2071
     */
    status: number;
    /**
     * 
...
export function InlineResponse2071FromJSON(json: any): InlineResponse2071 {
    return InlineResponse2071FromJSONTyped(json, false);
}

export function InlineResponse2071FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse2071 {
...
export function InlineResponse2071ToJSON(value?: InlineResponse2071 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
