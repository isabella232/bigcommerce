...
export function CountFullFromJSON(json: any): CountFull {
    return CountFullFromJSONTyped(json, false);
}

export function CountFullFromJSONTyped(json: any, ignoreDiscriminator: boolean): CountFull {
...
export function CountFullToJSON(value?: CountFull | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
