...
export function CustomerFormFieldsFromJSON(json: any): CustomerFormFields {
    return CustomerFormFieldsFromJSONTyped(json, false);
}

export function CustomerFormFieldsFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomerFormFields {
...
export function CustomerFormFieldsToJSON(value?: CustomerFormFields | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
