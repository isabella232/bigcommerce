...
export function StatesResourceFromJSON(json: any): StatesResource {
    return StatesResourceFromJSONTyped(json, false);
}

export function StatesResourceFromJSONTyped(json: any, ignoreDiscriminator: boolean): StatesResource {
...
export function StatesResourceToJSON(value?: StatesResource | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
