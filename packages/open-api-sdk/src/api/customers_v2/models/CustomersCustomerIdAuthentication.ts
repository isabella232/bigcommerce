 ...
 * @export
 * @interface CustomersCustomerIdAuthentication
 */
export interface CustomersCustomerIdAuthentication {
    /**
     * 
     * @type {boolean}
     * @memberof CustomersCustomerIdAuthentication
     */
    forceReset?: boolean;
    /**
     * 
...
export function CustomersCustomerIdAuthenticationFromJSON(json: any): CustomersCustomerIdAuthentication {
    return CustomersCustomerIdAuthenticationFromJSONTyped(json, false);
}

export function CustomersCustomerIdAuthenticationFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomersCustomerIdAuthentication {
...
export function CustomersCustomerIdAuthenticationToJSON(value?: CustomersCustomerIdAuthentication | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
