 ...
 * 
 * @export
 * @interface CustomerGroupPostDiscountRules
 */
export interface CustomerGroupPostDiscountRules {
    /**
     * 
     * @type {string}
     * @memberof CustomerGroupPostDiscountRules
     */
    type?: CustomerGroupPostDiscountRulesTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof CustomerGroupPostDiscountRules
     */
    method?: CustomerGroupPostDiscountRulesMethodEnum;
    /**
    ...
    priceListId?: number;
    /**
     * Required field in the request body when you select product for rule `type`. `product_id` and `type` are returned fields.
     * @type {number}
     * @memberof CustomerGroupPostDiscountRules
     */
    productId?: number;
    /**
     * Required field in the request body when you select category for rule `type`. `category_id` and `type` are returned fields.
     * @type {number}
     * @memberof CustomerGroupPostDiscountRules
     */
    categoryId?: number;
...
* @enum {string}
*/
export enum CustomerGroupPostDiscountRulesTypeEnum {
...
* @enum {string}
*/
export enum CustomerGroupPostDiscountRulesMethodEnum {
    Percent = 'percent',
    Fixed = 'fixed',
    Price = 'price'
}

export function CustomerGroupPostDiscountRulesFromJSON(json: any): CustomerGroupPostDiscountRules {
    return CustomerGroupPostDiscountRulesFromJSONTyped(json, false);
}

export function CustomerGroupPostDiscountRulesFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomerGroupPostDiscountRules {
...
export function CustomerGroupPostDiscountRulesToJSON(value?: CustomerGroupPostDiscountRules | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
