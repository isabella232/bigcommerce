 ...
 * 
 * @export
 * @interface ShippingAddressFull
 */
export interface ShippingAddressFull {
    /**
     * URL of the shipping address for api requests
     * @type {string}
     * @memberof ShippingAddressFull
     */
    url?: string;
    /**
     * 
...
export function ShippingAddressFullFromJSON(json: any): ShippingAddressFull {
    return ShippingAddressFullFromJSONTyped(json, false);
}

export function ShippingAddressFullFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShippingAddressFull {
...
export function ShippingAddressFullToJSON(value?: ShippingAddressFull | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
