 ...
 * 
 * @export
 * @interface AddressFieldResource
 */
export interface AddressFieldResource {
    /**
     * Full URL of where the resource is located.
     * @type {string}
     * @memberof AddressFieldResource
     */
    url?: string;
    /**
...
export function AddressFieldResourceFromJSON(json: any): AddressFieldResource {
    return AddressFieldResourceFromJSONTyped(json, false);
}

export function AddressFieldResourceFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddressFieldResource {
...
export function AddressFieldResourceToJSON(value?: AddressFieldResource | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
