...
export interface ConfigFull {
     ...
     * @memberof ConfigFull
     */
    dateLimitMode?: ConfigFullDateLimitModeEnum;
    /**
     ...
     * @memberof ConfigFull
     */
    fileTypesMode?: ConfigFullFileTypesModeEnum;
    /**
     ...
     * @memberof ConfigFull
     */
    numberLimitMode?: ConfigFullNumberLimitModeEnum;
    /**
     ...
     * @memberof ConfigFull
     */
    productListShippingCalc?: ConfigFullProductListShippingCalcEnum;
}
...
* @enum {string}
*/
export enum ConfigFullDateLimitModeEnum {
    Earliest = 'earliest',
    Range = 'range',
    Latest = 'latest'
}/**
...
* @enum {string}
*/
export enum ConfigFullFileTypesModeEnum {
    Specific = 'specific',
    All = 'all'
}/**
* @export
* @enum {string}
*/
export enum ConfigFullNumberLimitModeEnum {
    Lowest = 'lowest',
    Highest = 'highest',
    Range = 'range'
}/**
...
* @enum {string}
*/
export enum ConfigFullProductListShippingCalcEnum {
    None = 'none',
    Weight = 'weight',
    Package = 'package'
}

export function ConfigFullFromJSON(json: any): ConfigFull {
    return ConfigFullFromJSONTyped(json, false);
}

export function ConfigFullFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConfigFull {
...
export function ConfigFullToJSON(value?: ConfigFull | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
