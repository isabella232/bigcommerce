...
export interface InlineResponse2007 {
     ...
     */
    data?: Array<BulkPricingRuleFull>;
    /**
     * 
...
export function InlineResponse2007FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse2007 {
    ...
    return {
        ...
        'data': !exists(json, 'data') ? undefined : ((json['data'] as Array<any>).map(BulkPricingRuleFullFromJSON)),
...
export function InlineResponse2007ToJSON(value?: InlineResponse2007 | null): any {
    ...
    return {
        ...
        'data': value.data === undefined ? undefined : ((value.data as Array<any>).map(BulkPricingRuleFullToJSON)),
