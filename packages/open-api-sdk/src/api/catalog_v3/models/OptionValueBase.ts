 ...
 * @export
 * @interface OptionValueBase
 */
export interface OptionValueBase {
    /**
...
export function OptionValueBaseFromJSON(json: any): OptionValueBase {
    return OptionValueBaseFromJSONTyped(json, false);
}

export function OptionValueBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): OptionValueBase {
...
export function OptionValueBaseToJSON(value?: OptionValueBase | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
