...
export function ComplexRuleConditionFromJSON(json: any): ComplexRuleCondition {
    return ComplexRuleConditionFromJSONTyped(json, false);
}

export function ComplexRuleConditionFromJSONTyped(json: any, ignoreDiscriminator: boolean): ComplexRuleCondition {
...
export function ComplexRuleConditionToJSON(value?: ComplexRuleCondition | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
