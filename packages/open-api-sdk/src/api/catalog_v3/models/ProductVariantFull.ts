...
import {
    ...
    ProductVariantFullAllOf,
    ProductVariantFullAllOfFromJSON,
    ProductVariantFullAllOfFromJSONTyped,
    ProductVariantFullAllOfToJSON,
...
export function ProductVariantFullFromJSON(json: any): ProductVariantFull {
    return ProductVariantFullFromJSONTyped(json, false);
}

export function ProductVariantFullFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductVariantFull {
    ...
    return {
        ...
        'calculatedWeight': !exists(json, 'calculated_weight') ? undefined : json['calculated_weight'],
    };
}

export function ProductVariantFullToJSON(value?: ProductVariantFull | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'calculated_weight': value.calculatedWeight,
    };
}
