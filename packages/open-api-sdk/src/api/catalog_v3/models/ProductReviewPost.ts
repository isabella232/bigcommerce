 ...
 * @export
 * @interface ProductReviewPost
 */
export interface ProductReviewPost {
    /**
     * The title for the product review.
     * Required in /POST.
     * @type {string}
     * @memberof ProductReviewPost
     */
    title: string;
    /**
...
export function ProductReviewPostFromJSON(json: any): ProductReviewPost {
    return ProductReviewPostFromJSONTyped(json, false);
}

export function ProductReviewPostFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductReviewPost {
...
export function ProductReviewPostToJSON(value?: ProductReviewPost | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
