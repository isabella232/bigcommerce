 ...
 * @export
 * @interface ComplexRuleCondition1
 */
export interface ComplexRuleCondition1 {
    /**
     * The unique numeric ID of the rule condition; increments sequentially. Read-Only
     * @type {number}
     * @memberof ComplexRuleCondition1
     */
    id?: number;
    /**
...
export function ComplexRuleCondition1FromJSON(json: any): ComplexRuleCondition1 {
    return ComplexRuleCondition1FromJSONTyped(json, false);
}

export function ComplexRuleCondition1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ComplexRuleCondition1 {
...
export function ComplexRuleCondition1ToJSON(value?: ComplexRuleCondition1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
