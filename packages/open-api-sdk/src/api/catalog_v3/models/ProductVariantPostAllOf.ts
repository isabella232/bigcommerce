 ...
 * 
 * @export
 * @interface ProductVariantPostAllOf
 */
export interface ProductVariantPostAllOf {
    /**
     * 
     * @type {number}
     * @memberof ProductVariantPostAllOf
     */
    productId?: number;
    /**
     * 
...
export function ProductVariantPostAllOfFromJSON(json: any): ProductVariantPostAllOf {
    return ProductVariantPostAllOfFromJSONTyped(json, false);
}

export function ProductVariantPostAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductVariantPostAllOf {
...
export function ProductVariantPostAllOfToJSON(value?: ProductVariantPostAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
