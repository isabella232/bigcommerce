...
* @enum {string}
*/
export enum BulkPricingRuleTypeEnum {
    Price = 'price',
    Percent = 'percent',
    Fixed = 'fixed'
}

export function BulkPricingRuleFromJSON(json: any): BulkPricingRule {
    return BulkPricingRuleFromJSONTyped(json, false);
}

export function BulkPricingRuleFromJSONTyped(json: any, ignoreDiscriminator: boolean): BulkPricingRule {
...
export function BulkPricingRuleToJSON(value?: BulkPricingRule | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
