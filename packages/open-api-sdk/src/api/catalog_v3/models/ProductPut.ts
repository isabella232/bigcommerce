...
import {
    ...
    ProductPutAllOf,
    ProductPutAllOfFromJSON,
    ProductPutAllOfFromJSONTyped,
    ProductPutAllOfToJSON,
    ProductPutAllOf1,
    ProductPutAllOf1FromJSON,
    ProductPutAllOf1FromJSONTyped,
    ProductPutAllOf1ToJSON,
    ProductVariantPutProduct,
    ProductVariantPutProductFromJSON,
    ProductVariantPutProductFromJSONTyped,
    ProductVariantPutProductToJSON,
    ProductVideoFull,
...
export interface ProductPut {
     ...
     * @memberof ProductPut
     */
    inventoryTracking?: ProductPutInventoryTrackingEnum;
    /**
     ...
     * @memberof ProductPut
     */
    availability?: ProductPutAvailabilityEnum;
    /**
     ...
     * @memberof ProductPut
     */
    giftWrappingOptionsType?: ProductPutGiftWrappingOptionsTypeEnum;
    /**
     ...
     * @memberof ProductPut
     */
    condition?: ProductPutConditionEnum;
    /**
     ...
     * @memberof ProductPut
     */
    openGraphType?: ProductPutOpenGraphTypeEnum;
    /**
    ...
    /**
     * 
     * @type {Array<ProductVariantPutProduct>}
     * @memberof ProductPut
     */
...
* @enum {string}
*/
export enum ProductPutTypeEnum {
    Physical = 'physical',
    Digital = 'digital'
}/**
* @export
* @enum {string}
*/
export enum ProductPutInventoryTrackingEnum {
    None = 'none',
    Product = 'product',
    Variant = 'variant'
}/**
...
* @enum {string}
*/
export enum ProductPutAvailabilityEnum {
    Available = 'available',
    Disabled = 'disabled',
    Preorder = 'preorder'
}/**
...
* @enum {string}
*/
export enum ProductPutGiftWrappingOptionsTypeEnum {
    Any = 'any',
    None = 'none',
    List = 'list'
}/**
...
* @enum {string}
*/
export enum ProductPutConditionEnum {
    New = 'New',
    Used = 'Used',
...
* @enum {string}
*/
export enum ProductPutOpenGraphTypeEnum {
    Product = 'product',
    Album = 'album',
    Book = 'book',
    Drink = 'drink',
...
export function ProductPutFromJSON(json: any): ProductPut {
    return ProductPutFromJSONTyped(json, false);
}

export function ProductPutFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductPut {
    ...
    return {
        ...
        'variants': !exists(json, 'variants') ? undefined : ((json['variants'] as Array<any>).map(ProductVariantPutProductFromJSON)),
    };
}

export function ProductPutToJSON(value?: ProductPut | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'variants': value.variants === undefined ? undefined : ((value.variants as Array<any>).map(ProductVariantPutProductToJSON)),
    };
}
