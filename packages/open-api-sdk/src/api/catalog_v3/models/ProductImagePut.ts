...
import {
    ...
    ProductImageBase1,
    ProductImageBase1FromJSON,
    ProductImageBase1FromJSONTyped,
    ProductImageBase1ToJSON,
} from './';

/**
 * The model for a PUT to update applicable Product Image fields.
 * @export
 * @interface ProductImagePut
 */
export interface ProductImagePut {
    /**
     * The unique numeric identifier for the product with which the image is associated.
     * @type {number}
     * @memberof ProductImagePut
     */
    productId?: number;
    /**
...
export function ProductImagePutFromJSON(json: any): ProductImagePut {
    return ProductImagePutFromJSONTyped(json, false);
}

export function ProductImagePutFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductImagePut {
...
export function ProductImagePutToJSON(value?: ProductImagePut | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
