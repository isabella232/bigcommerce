 ...
 * @export
 * @interface ProductVariantPutProduct
 */
export interface ProductVariantPutProduct {
    /**
     * The cost price of the variant. Not affected by Price List prices.
     * @type {number}
     * @memberof ProductVariantPutProduct
     */
...
export function ProductVariantPutProductFromJSON(json: any): ProductVariantPutProduct {
    return ProductVariantPutProductFromJSONTyped(json, false);
}

export function ProductVariantPutProductFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductVariantPutProduct {
...
export function ProductVariantPutProductToJSON(value?: ProductVariantPutProduct | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
