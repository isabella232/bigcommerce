 ...
 * @export
 * @interface VariantBase1
 */
export interface VariantBase1 {
    /**
     * The cost price of the variant. Not affected by Price List prices.
     * @type {number}
     * @memberof VariantBase1
     */
...
export function VariantBase1FromJSON(json: any): VariantBase1 {
    return VariantBase1FromJSONTyped(json, false);
}

export function VariantBase1FromJSONTyped(json: any, ignoreDiscriminator: boolean): VariantBase1 {
...
export function VariantBase1ToJSON(value?: VariantBase1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
