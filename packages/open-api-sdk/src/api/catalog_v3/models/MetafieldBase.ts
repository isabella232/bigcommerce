 ...
 */
export interface MetafieldBase {
    /**
     * Unique ID of the *Metafield*. Read-Only.
     * @type {number}
     * @memberof MetafieldBase
     */
    id?: number;
    /**
     ...
     * @memberof MetafieldBase
     */
    permissionSet: MetafieldBasePermissionSetEnum;
    /**
     ...
     * @memberof MetafieldBase
     */
    resourceType?: MetafieldBaseResourceTypeEnum;
    /**
...
* @enum {string}
*/
export enum MetafieldBasePermissionSetEnum {
    AppOnly = 'app_only',
    Read = 'read',
    Write = 'write',
...
* @enum {string}
*/
export enum MetafieldBaseResourceTypeEnum {
    Category = 'category',
    Brand = 'brand',
    Product = 'product',
    Variant = 'variant'
...
export function MetafieldBaseFromJSON(json: any): MetafieldBase {
    return MetafieldBaseFromJSONTyped(json, false);
}

export function MetafieldBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): MetafieldBase {
...
export function MetafieldBaseToJSON(value?: MetafieldBase | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
