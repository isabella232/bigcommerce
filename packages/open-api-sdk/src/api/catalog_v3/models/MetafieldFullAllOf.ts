 ...
 * 
 * @export
 * @interface MetafieldFullAllOf
 */
export interface MetafieldFullAllOf {
    /**
     * Date and time of the metafield's creation. Read-Only.
     * @type {Date}
     * @memberof MetafieldFullAllOf
     */
    dateCreated?: Date;
    /**
...
export function MetafieldFullAllOfFromJSON(json: any): MetafieldFullAllOf {
    return MetafieldFullAllOfFromJSONTyped(json, false);
}

export function MetafieldFullAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): MetafieldFullAllOf {
...
export function MetafieldFullAllOfToJSON(value?: MetafieldFullAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
