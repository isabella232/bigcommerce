...
export function ProductReviewBaseFromJSON(json: any): ProductReviewBase {
    return ProductReviewBaseFromJSONTyped(json, false);
}

export function ProductReviewBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductReviewBase {
...
export function ProductReviewBaseToJSON(value?: ProductReviewBase | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
