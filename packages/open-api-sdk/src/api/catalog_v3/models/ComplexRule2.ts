...
import {
    Adjuster,
    AdjusterFromJSON,
    AdjusterFromJSONTyped,
    AdjusterToJSON,
    ComplexRuleCondition,
    ComplexRuleConditionFromJSON,
    ComplexRuleConditionFromJSONTyped,
    ComplexRuleConditionToJSON,
} from './';

/**
 * Common ComplexRule properties.
 * @export
 * @interface ComplexRule2
 */
export interface ComplexRule2 {
    /**
     * The unique numeric ID of the rule; increments sequentially.
     * Read-Only
     * @type {number}
     * @memberof ComplexRule2
     */
    id?: number;
    /**
     ...
     * @memberof ComplexRule2
     */
    priceAdjuster?: Adjuster;
    /**
     * 
     * @type {Adjuster}
     * @memberof ComplexRule2
     */
    weightAdjuster?: Adjuster;
    /**
     * 
     * @type {Array<ComplexRuleCondition>}
     * @memberof ComplexRule2
     */
    conditions?: Array<ComplexRuleCondition>;
}

export function ComplexRule2FromJSON(json: any): ComplexRule2 {
    return ComplexRule2FromJSONTyped(json, false);
}

export function ComplexRule2FromJSONTyped(json: any, ignoreDiscriminator: boolean): ComplexRule2 {
    ...
    return {
        ...
        'priceAdjuster': !exists(json, 'price_adjuster') ? undefined : AdjusterFromJSON(json['price_adjuster']),
        'weightAdjuster': !exists(json, 'weight_adjuster') ? undefined : AdjusterFromJSON(json['weight_adjuster']),
        'conditions': !exists(json, 'conditions') ? undefined : ((json['conditions'] as Array<any>).map(ComplexRuleConditionFromJSON)),
    };
}

export function ComplexRule2ToJSON(value?: ComplexRule2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'price_adjuster': AdjusterToJSON(value.priceAdjuster),
        'weight_adjuster': AdjusterToJSON(value.weightAdjuster),
        'conditions': value.conditions === undefined ? undefined : ((value.conditions as Array<any>).map(ComplexRuleConditionToJSON)),
    };
}
