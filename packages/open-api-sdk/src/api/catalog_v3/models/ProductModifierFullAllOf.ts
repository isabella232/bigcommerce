 ...
 * 
 * @export
 * @interface ProductModifierFullAllOf
 */
export interface ProductModifierFullAllOf {
    /**
     * The unique numeric ID of the modifier; increments sequentially.
     * @type {number}
     * @memberof ProductModifierFullAllOf
     */
    id?: number;
    /**
...
export function ProductModifierFullAllOfFromJSON(json: any): ProductModifierFullAllOf {
    return ProductModifierFullAllOfFromJSONTyped(json, false);
}

export function ProductModifierFullAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductModifierFullAllOf {
...
export function ProductModifierFullAllOfToJSON(value?: ProductModifierFullAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
