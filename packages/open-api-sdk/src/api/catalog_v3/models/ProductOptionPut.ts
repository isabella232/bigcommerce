 ...
 * @export
 * @interface ProductOptionPut
 */
export interface ProductOptionPut {
    /**
     * The unique numerical ID of the option, increments sequentially.
     * @type {number}
     * @memberof ProductOptionPut
     */
    id?: number | null;
    /**
...
* @enum {string}
*/
export enum ProductOptionPutTypeEnum {
...
export function ProductOptionPutFromJSON(json: any): ProductOptionPut {
    return ProductOptionPutFromJSONTyped(json, false);
}

export function ProductOptionPutFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductOptionPut {
...
export function ProductOptionPutToJSON(value?: ProductOptionPut | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
