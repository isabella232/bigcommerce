...
export interface OptionConfig {
     ...
     * @memberof OptionConfig
     */
    dateLimitMode?: OptionConfigDateLimitModeEnum;
    /**
     ...
     * @memberof OptionConfig
     */
    fileTypesMode?: OptionConfigFileTypesModeEnum;
    /**
     ...
     * @memberof OptionConfig
     */
    numberLimitMode?: OptionConfigNumberLimitModeEnum;
    /**
     ...
     * @memberof OptionConfig
     */
    productListShippingCalc?: OptionConfigProductListShippingCalcEnum;
}
...
* @enum {string}
*/
export enum OptionConfigDateLimitModeEnum {
    Earliest = 'earliest',
    Range = 'range',
    Latest = 'latest'
}/**
...
* @enum {string}
*/
export enum OptionConfigFileTypesModeEnum {
    Specific = 'specific',
    All = 'all'
}/**
* @export
* @enum {string}
*/
export enum OptionConfigNumberLimitModeEnum {
    Lowest = 'lowest',
    Highest = 'highest',
    Range = 'range'
}/**
...
* @enum {string}
*/
export enum OptionConfigProductListShippingCalcEnum {
    None = 'none',
    Weight = 'weight',
    Package = 'package'
}

export function OptionConfigFromJSON(json: any): OptionConfig {
    return OptionConfigFromJSONTyped(json, false);
}

export function OptionConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): OptionConfig {
...
export function OptionConfigToJSON(value?: OptionConfig | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
