...
export interface ProductOptionBase {
     ...
     * @memberof ProductOptionBase
     */
    type?: ProductOptionBaseTypeEnum;
    /**
     * 
...
* @enum {string}
*/
export enum ProductOptionBaseTypeEnum {
...
export function ProductOptionBaseFromJSON(json: any): ProductOptionBase {
    return ProductOptionBaseFromJSONTyped(json, false);
}

export function ProductOptionBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductOptionBase {
...
export function ProductOptionBaseToJSON(value?: ProductOptionBase | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
