...
* @enum {string}
*/
export enum ProductVideoPostTypeEnum {
    Youtube = 'youtube'
}

export function ProductVideoPostFromJSON(json: any): ProductVideoPost {
    return ProductVideoPostFromJSONTyped(json, false);
}

export function ProductVideoPostFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductVideoPost {
...
export function ProductVideoPostToJSON(value?: ProductVideoPost | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
