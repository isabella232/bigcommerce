 ...
 * 
 * @export
 * @interface ProductReviewFullAllOf
 */
export interface ProductReviewFullAllOf {
    /**
     * The unique numeric ID of the product review; increments sequentially.
     * @type {number}
     * @memberof ProductReviewFullAllOf
     */
    id?: number;
    /**
...
export function ProductReviewFullAllOfFromJSON(json: any): ProductReviewFullAllOf {
    return ProductReviewFullAllOfFromJSONTyped(json, false);
}

export function ProductReviewFullAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductReviewFullAllOf {
...
export function ProductReviewFullAllOfToJSON(value?: ProductReviewFullAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
