...
export function ProductVariantBaseFromJSON(json: any): ProductVariantBase {
    return ProductVariantBaseFromJSONTyped(json, false);
}

export function ProductVariantBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductVariantBase {
...
export function ProductVariantBaseToJSON(value?: ProductVariantBase | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
