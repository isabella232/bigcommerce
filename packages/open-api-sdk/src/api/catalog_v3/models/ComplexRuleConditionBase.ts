 ...
 * @export
 * @interface ComplexRuleConditionBase
 */
export interface ComplexRuleConditionBase {
    /**
     * The unique numeric ID of the rule condition; increments sequentially. Read-Only
     * @type {number}
     * @memberof ComplexRuleConditionBase
     */
    id?: number | null;
    /**
...
export function ComplexRuleConditionBaseFromJSON(json: any): ComplexRuleConditionBase {
    return ComplexRuleConditionBaseFromJSONTyped(json, false);
}

export function ComplexRuleConditionBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ComplexRuleConditionBase {
    ...
    return {
        ...
        'modifierValueId': json['modifier_value_id'],
        'variantId': json['variant_id'],
        'combinationId': !exists(json, 'combination_id') ? undefined : json['combination_id'],
    };
}

export function ComplexRuleConditionBaseToJSON(value?: ComplexRuleConditionBase | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'modifier_value_id': value.modifierValueId,
