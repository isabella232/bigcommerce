...
* @enum {string}
*/
export enum OptionBaseTypeEnum {
...
export function OptionBaseFromJSON(json: any): OptionBase {
    return OptionBaseFromJSONTyped(json, false);
}

export function OptionBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): OptionBase {
...
export function OptionBaseToJSON(value?: OptionBase | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
