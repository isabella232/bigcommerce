...
export function Brand1FromJSON(json: any): Brand1 {
    return Brand1FromJSONTyped(json, false);
}

export function Brand1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Brand1 {
...
export function Brand1ToJSON(value?: Brand1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
