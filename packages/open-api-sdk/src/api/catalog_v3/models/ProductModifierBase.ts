...
export interface ProductModifierBase {
     ...
     * @type {string}
     * @memberof ProductModifierBase
     */
    type: ProductModifierBaseTypeEnum;
    /**
...
* @enum {string}
*/
export enum ProductModifierBaseTypeEnum {
    Date = 'date',
    Checkbox = 'checkbox',
    File = 'file',
    Text = 'text',
...
export function ProductModifierBaseFromJSON(json: any): ProductModifierBase {
    return ProductModifierBaseFromJSONTyped(json, false);
}

export function ProductModifierBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductModifierBase {
...
export function ProductModifierBaseToJSON(value?: ProductModifierBase | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
