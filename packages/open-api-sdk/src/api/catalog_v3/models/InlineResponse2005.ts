...
import {
    ...
    ProductCustomFieldBaseFromJSON,
    ProductCustomFieldBaseFromJSONTyped,
    ProductCustomFieldBaseToJSON,
} from './';
...
export function InlineResponse2005FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse2005 {
    ...
    return {
        ...
        'data': !exists(json, 'data') ? undefined : ProductCustomFieldBaseFromJSON(json['data']),
...
export function InlineResponse2005ToJSON(value?: InlineResponse2005 | null): any {
    ...
    return {
        ...
        'data': ProductCustomFieldBaseToJSON(value.data),
        'meta': value.meta,
    };
}
