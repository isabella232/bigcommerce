...
export function CustomField3FromJSON(json: any): CustomField3 {
    return CustomField3FromJSONTyped(json, false);
}

export function CustomField3FromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomField3 {
...
export function CustomField3ToJSON(value?: CustomField3 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
