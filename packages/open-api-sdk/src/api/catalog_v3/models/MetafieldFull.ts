...
import {
    MetafieldFullAllOf,
    MetafieldFullAllOfFromJSON,
    MetafieldFullAllOfFromJSONTyped,
    MetafieldFullAllOfToJSON,
    MetafieldPut,
    MetafieldPutFromJSON,
    MetafieldPutFromJSONTyped,
    MetafieldPutToJSON,
} from './';
 ...
 * 
 * @export
 * @interface MetafieldFull
 */
export interface MetafieldFull {
    /**
     * Unique ID of the *Metafield*. Read-Only.
     * @type {number}
     * @memberof MetafieldFull
     */
    id?: number;
    /**
     ...
     * @memberof MetafieldFull
     */
    permissionSet: MetafieldFullPermissionSetEnum;
    /**
     ...
     * @memberof MetafieldFull
     */
    resourceType?: MetafieldFullResourceTypeEnum;
    /**
...
* @enum {string}
*/
export enum MetafieldFullPermissionSetEnum {
    AppOnly = 'app_only',
    Read = 'read',
    Write = 'write',
...
* @enum {string}
*/
export enum MetafieldFullResourceTypeEnum {
    Category = 'category',
    Brand = 'brand',
    Product = 'product',
    Variant = 'variant'
...
export function MetafieldFullFromJSON(json: any): MetafieldFull {
    return MetafieldFullFromJSONTyped(json, false);
}

export function MetafieldFullFromJSONTyped(json: any, ignoreDiscriminator: boolean): MetafieldFull {
...
export function MetafieldFullToJSON(value?: MetafieldFull | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
