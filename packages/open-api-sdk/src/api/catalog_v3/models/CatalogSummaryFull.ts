 ...
 * @export
 * @interface CatalogSummaryFull
 */
export interface CatalogSummaryFull {
    /**
     * A count of all inventory items in the catalog.
     * @type {number}
     * @memberof CatalogSummaryFull
     */
...
export function CatalogSummaryFullFromJSON(json: any): CatalogSummaryFull {
    return CatalogSummaryFullFromJSONTyped(json, false);
}

export function CatalogSummaryFullFromJSONTyped(json: any, ignoreDiscriminator: boolean): CatalogSummaryFull {
...
export function CatalogSummaryFullToJSON(value?: CatalogSummaryFull | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
