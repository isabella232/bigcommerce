...
import {
    ...
    ComplexRuleConditionBaseFromJSON,
    ComplexRuleConditionBaseFromJSONTyped,
    ComplexRuleConditionBaseToJSON,
} from './';

/**
 * Common ComplexRule properties.
 * @export
 * @interface ComplexRuleBase
 */
export interface ComplexRuleBase {
    /**
     * The unique numeric ID of the rule; increments sequentially.
     * Read-Only
     * @type {number}
     * @memberof ComplexRuleBase
     */
    id?: number;
    /**
     ...
     * @memberof ComplexRuleBase
     */
    priceAdjuster?: AdjusterFull;
    /**
     * 
     * @type {AdjusterFull}
     * @memberof ComplexRuleBase
     */
    weightAdjuster?: AdjusterFull;
    /**
     * 
     * @type {Array<ComplexRuleConditionBase>}
     * @memberof ComplexRuleBase
     */
    conditions?: Array<ComplexRuleConditionBase>;
}

export function ComplexRuleBaseFromJSON(json: any): ComplexRuleBase {
    return ComplexRuleBaseFromJSONTyped(json, false);
}

export function ComplexRuleBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ComplexRuleBase {
    ...
    return {
        ...
        'priceAdjuster': !exists(json, 'price_adjuster') ? undefined : AdjusterFullFromJSON(json['price_adjuster']),
        'weightAdjuster': !exists(json, 'weight_adjuster') ? undefined : AdjusterFullFromJSON(json['weight_adjuster']),
        'conditions': !exists(json, 'conditions') ? undefined : ((json['conditions'] as Array<any>).map(ComplexRuleConditionBaseFromJSON)),
    };
}

export function ComplexRuleBaseToJSON(value?: ComplexRuleBase | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'price_adjuster': AdjusterFullToJSON(value.priceAdjuster),
        'weight_adjuster': AdjusterFullToJSON(value.weightAdjuster),
        'conditions': value.conditions === undefined ? undefined : ((value.conditions as Array<any>).map(ComplexRuleConditionBaseToJSON)),
    };
}
