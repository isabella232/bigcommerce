...
* @enum {string}
*/
export enum ProductVideoBaseTypeEnum {
    Youtube = 'youtube'
}

export function ProductVideoBaseFromJSON(json: any): ProductVideoBase {
    return ProductVideoBaseFromJSONTyped(json, false);
}

export function ProductVideoBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductVideoBase {
...
export function ProductVideoBaseToJSON(value?: ProductVideoBase | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
