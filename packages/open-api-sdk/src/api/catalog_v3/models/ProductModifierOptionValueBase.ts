 ...
 * @export
 * @interface ProductModifierOptionValueBase
 */
export interface ProductModifierOptionValueBase {
    /**
     ...
     * @type {boolean}
     * @memberof ProductModifierOptionValueBase
     */
    isDefault?: boolean;
    /**
...
export function ProductModifierOptionValueBaseFromJSON(json: any): ProductModifierOptionValueBase {
    return ProductModifierOptionValueBaseFromJSONTyped(json, false);
}

export function ProductModifierOptionValueBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductModifierOptionValueBase {
...
export function ProductModifierOptionValueBaseToJSON(value?: ProductModifierOptionValueBase | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
