...
import {
    ...
    ProductVariantPostProductAllOf,
    ProductVariantPostProductAllOfFromJSON,
    ProductVariantPostProductAllOfFromJSONTyped,
    ProductVariantPostProductAllOfToJSON,
} from './';

/**
 * The model for a POST to create variants on a product.
 * @export
 * @interface ProductVariantPostProduct
 */
export interface ProductVariantPostProduct {
    /**
     * The cost price of the variant. Not affected by Price List prices.
     * @type {number}
     * @memberof ProductVariantPostProduct
     */
...
export function ProductVariantPostProductFromJSON(json: any): ProductVariantPostProduct {
    return ProductVariantPostProductFromJSONTyped(json, false);
}

export function ProductVariantPostProductFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductVariantPostProduct {
...
export function ProductVariantPostProductToJSON(value?: ProductVariantPostProduct | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
