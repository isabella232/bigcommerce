...
export function ProductImageBaseFromJSON(json: any): ProductImageBase {
    return ProductImageBaseFromJSONTyped(json, false);
}

export function ProductImageBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductImageBase {
...
export function ProductImageBaseToJSON(value?: ProductImageBase | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
