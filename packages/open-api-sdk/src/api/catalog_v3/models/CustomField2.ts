...
export function CustomField2FromJSON(json: any): CustomField2 {
    return CustomField2FromJSONTyped(json, false);
}

export function CustomField2FromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomField2 {
...
export function CustomField2ToJSON(value?: CustomField2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
