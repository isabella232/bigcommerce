...
import {
    BulkPricingRule,
    BulkPricingRuleFromJSON,
    BulkPricingRuleFromJSONTyped,
    BulkPricingRuleToJSON,
} from './';
...
export function InlineResponse2009FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse2009 {
    ...
    return {
        ...
        'data': !exists(json, 'data') ? undefined : BulkPricingRuleFromJSON(json['data']),
...
export function InlineResponse2009ToJSON(value?: InlineResponse2009 | null): any {
    ...
    return {
        ...
        'data': BulkPricingRuleToJSON(value.data),
        'meta': value.meta,
    };
}
