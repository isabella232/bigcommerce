...
export interface CreateReturnRequestItem {
     ...
     * @memberof CreateReturnRequestItem
     */
...
export function CreateReturnRequestItemFromJSON(json: any): CreateReturnRequestItem {
    return CreateReturnRequestItemFromJSONTyped(json, false);
}

export function CreateReturnRequestItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateReturnRequestItem {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'referenceId': ItemReferenceIdFromJSON(json['reference_id']),
        'quantity': json['quantity'],
        'preferredOutcomeId': json['preferred_outcome_id'],
        'reasonId': json['reason_id'],
    };
}

export function CreateReturnRequestItemToJSON(value?: CreateReturnRequestItem | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'preferred_outcome_id': value.preferredOutcomeId,
