 ...
 * * `HANDLING`
 * @export
 * @interface AmountBoundItem
 */
export interface AmountBoundItem {
    /**
     * Type of refund.
     * @type {string}
     * @memberof AmountBoundItem
     */
    itemType?: AmountBoundItemItemTypeEnum;
    /**
     * Order address ID.
     * @type {number}
     * @memberof AmountBoundItem
...
* @enum {string}
*/
export enum AmountBoundItemItemTypeEnum {
    Shipping = 'SHIPPING',
    Handling = 'HANDLING'
}

export function AmountBoundItemFromJSON(json: any): AmountBoundItem {
    return AmountBoundItemFromJSONTyped(json, false);
}

export function AmountBoundItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): AmountBoundItem {
...
export function AmountBoundItemToJSON(value?: AmountBoundItem | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
