...
export function BatchOperationMetaFromJSON(json: any): BatchOperationMeta {
    return BatchOperationMetaFromJSONTyped(json, false);
}

export function BatchOperationMetaFromJSONTyped(json: any, ignoreDiscriminator: boolean): BatchOperationMeta {
...
export function BatchOperationMetaToJSON(value?: BatchOperationMeta | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
