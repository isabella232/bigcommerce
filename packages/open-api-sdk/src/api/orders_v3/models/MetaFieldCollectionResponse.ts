...
export function MetaFieldCollectionResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): MetaFieldCollectionResponse {
    ...
    return {
        ...
        'data': !exists(json, 'data') ? undefined : ((json['data'] as Array<any>).map(MetafieldFromJSON)),
...
export function MetaFieldCollectionResponseToJSON(value?: MetaFieldCollectionResponse | null): any {
    ...
    return {
        ...
        'data': value.data === undefined ? undefined : ((value.data as Array<any>).map(MetafieldToJSON)),
