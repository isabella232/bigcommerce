 ...
 * @export
 * @interface RefundRequestPost
 */
export interface RefundRequestPost {
    /**
     * 
     * @type {Array<object>}
     * @memberof RefundRequestPost
     */
    items: Array<object>;
    /**
     * Reason for refund
...
export function RefundRequestPostFromJSON(json: any): RefundRequestPost {
    return RefundRequestPostFromJSONTyped(json, false);
}

export function RefundRequestPostFromJSONTyped(json: any, ignoreDiscriminator: boolean): RefundRequestPost {
    ...
    return {
        ...
        'payments': ((json['payments'] as Array<any>).map(PaymentRequestFromJSON)),
    };
}

export function RefundRequestPostToJSON(value?: RefundRequestPost | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'items': value.items,
        'reason': value.reason,
        'payments': ((value.payments as Array<any>).map(PaymentRequestToJSON)),
    };
}
