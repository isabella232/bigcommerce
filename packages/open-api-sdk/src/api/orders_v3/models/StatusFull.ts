 ...
 * @enum {string}
 */
export enum StatusFull {
    Closed = 'CLOSED',
    Open = 'OPEN',
    Removed = 'REMOVED'
}

export function StatusFullFromJSON(json: any): StatusFull {
    return StatusFullFromJSONTyped(json, false);
}

export function StatusFullFromJSONTyped(json: any, ignoreDiscriminator: boolean): StatusFull {
    return json as StatusFull;
}

export function StatusFullToJSON(value?: StatusFull | null): any {
    return value as any;
}
