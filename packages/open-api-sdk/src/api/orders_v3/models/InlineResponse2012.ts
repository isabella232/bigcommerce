...
export function InlineResponse2012FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse2012 {
    ...
    return {
        ...
        'data': !exists(json, 'data') ? undefined : ((json['data'] as Array<any>).map(RefundQuoteFullFromJSON)),
...
export function InlineResponse2012ToJSON(value?: InlineResponse2012 | null): any {
    ...
    return {
        ...
        'data': value.data === undefined ? undefined : ((value.data as Array<any>).map(RefundQuoteFullToJSON)),
