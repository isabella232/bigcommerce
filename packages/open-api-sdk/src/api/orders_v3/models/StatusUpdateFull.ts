 ...
 * 
 * @export
 * @interface StatusUpdateFull
 */
export interface StatusUpdateFull {
    /**
     * The ID of the return for which the status should be updated
     * @type {number}
     * @memberof StatusUpdateFull
     */
    returnId?: number;
    /**
     * 
     ...
     * @memberof StatusUpdateFull
     */
    newStatus?: StatusFull;
}

export function StatusUpdateFullFromJSON(json: any): StatusUpdateFull {
    return StatusUpdateFullFromJSONTyped(json, false);
}

export function StatusUpdateFullFromJSONTyped(json: any, ignoreDiscriminator: boolean): StatusUpdateFull {
    ...
    return {
        ...
        'newStatus': !exists(json, 'new_status') ? undefined : StatusFullFromJSON(json['new_status']),
    };
}

export function StatusUpdateFullToJSON(value?: StatusUpdateFull | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'new_status': StatusFullToJSON(value.newStatus),
    };
}
