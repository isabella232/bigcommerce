 ...
 * @export
 * @interface TransactionAllOfStoreCredit
 */
export interface TransactionAllOfStoreCredit {
    /**
     * Remaining balance of shopper's store credit.
     * @type {number}
     * @memberof TransactionAllOfStoreCredit
     */
    remainingBalance?: number;
}

export function TransactionAllOfStoreCreditFromJSON(json: any): TransactionAllOfStoreCredit {
    return TransactionAllOfStoreCreditFromJSONTyped(json, false);
}

export function TransactionAllOfStoreCreditFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransactionAllOfStoreCredit {
...
export function TransactionAllOfStoreCreditToJSON(value?: TransactionAllOfStoreCredit | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
