...
export interface RefundItem {
     ...
     * @memberof RefundItem
     */
    itemType?: RefundItemItemTypeEnum;
    /**
...
* @enum {string}
*/
export enum RefundItemItemTypeEnum {
    Product = 'PRODUCT',
...
export function RefundItemFromJSON(json: any): RefundItem {
    return RefundItemFromJSONTyped(json, false);
}

export function RefundItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): RefundItem {
    ...
    return {
        ...
        'requestedAmount': !exists(json, 'requested_amount') ? undefined : json['requested_amount'],
    };
}

export function RefundItemToJSON(value?: RefundItem | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
