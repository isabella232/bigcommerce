...
export function OfflineFromJSON(json: any): Offline {
    return OfflineFromJSONTyped(json, false);
}

export function OfflineFromJSONTyped(json: any, ignoreDiscriminator: boolean): Offline {
...
export function OfflineToJSON(value?: Offline | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
