...
export function CVVResultFromJSON(json: any): CVVResult {
    return CVVResultFromJSONTyped(json, false);
}

export function CVVResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): CVVResult {
...
export function CVVResultToJSON(value?: CVVResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
