...
import {
    ...
    CreateReturnRequestItemFromJSON,
    CreateReturnRequestItemFromJSONTyped,
    CreateReturnRequestItemToJSON,
} from './';
...
export interface CreateReturnRequest {
     ...
     * @type {Array<CreateReturnRequestItem>}
...
export function CreateReturnRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateReturnRequest {
    ...
    return {
        ...
        'items': ((json['items'] as Array<any>).map(CreateReturnRequestItemFromJSON)),
...
export function CreateReturnRequestToJSON(value?: CreateReturnRequest | null): any {
    ...
    return {
        ...
        'items': ((value.items as Array<any>).map(CreateReturnRequestItemToJSON)),
