...
export function Custom1FromJSON(json: any): Custom1 {
    return Custom1FromJSONTyped(json, false);
}

export function Custom1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Custom1 {
...
export function Custom1ToJSON(value?: Custom1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
