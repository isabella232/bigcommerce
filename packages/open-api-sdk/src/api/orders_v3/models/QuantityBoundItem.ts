 ...
 * * `GIFT_WRAPPING`
 * @export
 * @interface QuantityBoundItem
 */
export interface QuantityBoundItem {
    /**
     * Type of refund.
     * @type {string}
     * @memberof QuantityBoundItem
     */
    itemType?: QuantityBoundItemItemTypeEnum;
    /**
     * Order Product ID. 
     * @type {number}
     * @memberof QuantityBoundItem
...
* @enum {string}
*/
export enum QuantityBoundItemItemTypeEnum {
    Product = 'PRODUCT',
    GiftWrapping = 'GIFT_WRAPPING'
}

export function QuantityBoundItemFromJSON(json: any): QuantityBoundItem {
    return QuantityBoundItemFromJSONTyped(json, false);
}

export function QuantityBoundItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): QuantityBoundItem {
...
export function QuantityBoundItemToJSON(value?: QuantityBoundItem | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
