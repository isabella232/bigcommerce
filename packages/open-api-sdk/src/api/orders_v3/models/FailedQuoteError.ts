 ...
 * @export
 * @interface FailedQuoteError
 */
export interface FailedQuoteError {
    /**
     * 
     * @type {number}
     * @memberof FailedQuoteError
     */
    orderId?: number;
    /**
     * HTTP status code
...
export function FailedQuoteErrorFromJSON(json: any): FailedQuoteError {
    return FailedQuoteErrorFromJSONTyped(json, false);
}

export function FailedQuoteErrorFromJSONTyped(json: any, ignoreDiscriminator: boolean): FailedQuoteError {
...
export function FailedQuoteErrorToJSON(value?: FailedQuoteError | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
