 ...
 * 
 * @export
 * @interface ReturnItemPreferredOutcome
 */
export interface ReturnItemPreferredOutcome {
    /**
     * Unique identifier of the preferred outcome
     * @type {number}
     * @memberof ReturnItemPreferredOutcome
     */
    id?: number;
    /**
...
export function ReturnItemPreferredOutcomeFromJSON(json: any): ReturnItemPreferredOutcome {
    return ReturnItemPreferredOutcomeFromJSONTyped(json, false);
}

export function ReturnItemPreferredOutcomeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReturnItemPreferredOutcome {
...
export function ReturnItemPreferredOutcomeToJSON(value?: ReturnItemPreferredOutcome | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
