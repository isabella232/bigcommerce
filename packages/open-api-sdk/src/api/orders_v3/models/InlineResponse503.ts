...
export function InlineResponse503FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse503 {
    ...
    return {
        ...
        'data': !exists(json, 'data') ? undefined : ((json['data'] as Array<any>).map(FailedQuoteErrorFromJSON)),
...
export function InlineResponse503ToJSON(value?: InlineResponse503 | null): any {
    ...
    return {
        ...
        'data': value.data === undefined ? undefined : ((value.data as Array<any>).map(FailedQuoteErrorToJSON)),
