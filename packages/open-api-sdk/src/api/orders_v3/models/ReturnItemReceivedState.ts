 ...
 * 
 * @export
 * @interface ReturnItemReceivedState
 */
export interface ReturnItemReceivedState {
    /**
     * The quantity of items marked as received by the merchant
     * @type {number}
     * @memberof ReturnItemReceivedState
     */
...
export function ReturnItemReceivedStateFromJSON(json: any): ReturnItemReceivedState {
    return ReturnItemReceivedStateFromJSONTyped(json, false);
}

export function ReturnItemReceivedStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReturnItemReceivedState {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'receivedQuantity': !exists(json, 'received_quantity') ? undefined : json['received_quantity'],
        'pendingQuantity': !exists(json, 'pending_quantity') ? undefined : json['pending_quantity'],
    };
}

export function ReturnItemReceivedStateToJSON(value?: ReturnItemReceivedState | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
