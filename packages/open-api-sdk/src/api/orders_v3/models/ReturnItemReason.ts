 ...
 * 
 * @export
 * @interface ReturnItemReason
 */
export interface ReturnItemReason {
    /**
     * Unique identifier of the reason
     * @type {number}
     * @memberof ReturnItemReason
     */
    id?: number;
    /**
...
export function ReturnItemReasonFromJSON(json: any): ReturnItemReason {
    return ReturnItemReasonFromJSONTyped(json, false);
}

export function ReturnItemReasonFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReturnItemReason {
...
export function ReturnItemReasonToJSON(value?: ReturnItemReason | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
