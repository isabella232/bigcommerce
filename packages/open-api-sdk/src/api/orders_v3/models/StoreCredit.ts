...
export interface StoreCredit {
     ...
     * @type {number}
     * @memberof StoreCredit
     */
    remainingBalance?: number;
}

export function StoreCreditFromJSON(json: any): StoreCredit {
    return StoreCreditFromJSONTyped(json, false);
}

export function StoreCreditFromJSONTyped(json: any, ignoreDiscriminator: boolean): StoreCredit {
...
export function StoreCreditToJSON(value?: StoreCredit | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
