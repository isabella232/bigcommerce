 ...
 * 
 * @export
 * @interface ReturnFullCustomer
 */
export interface ReturnFullCustomer {
    /**
     * 
     * @type {number}
     * @memberof ReturnFullCustomer
     */
    id?: number;
    /**
     * 
...
export function ReturnFullCustomerFromJSON(json: any): ReturnFullCustomer {
    return ReturnFullCustomerFromJSONTyped(json, false);
}

export function ReturnFullCustomerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReturnFullCustomer {
...
export function ReturnFullCustomerToJSON(value?: ReturnFullCustomer | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
