...
export function Offline1FromJSON(json: any): Offline1 {
    return Offline1FromJSONTyped(json, false);
}

export function Offline1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Offline1 {
...
export function Offline1ToJSON(value?: Offline1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
