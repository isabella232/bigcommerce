 ...
 * @export
 * @interface RefundQuotePost
 */
export interface RefundQuotePost {
    /**
...
export function RefundQuotePostFromJSON(json: any): RefundQuotePost {
    return RefundQuotePostFromJSONTyped(json, false);
}

export function RefundQuotePostFromJSONTyped(json: any, ignoreDiscriminator: boolean): RefundQuotePost {
...
export function RefundQuotePostToJSON(value?: RefundQuotePost | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
