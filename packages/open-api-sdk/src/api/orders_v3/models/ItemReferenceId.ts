 ...
 * 
 * @export
 * @interface ItemReferenceId
 */
export interface ItemReferenceId {
    /**
     * The reference type
     * @type {string}
     * @memberof ItemReferenceId
     */
    type: ItemReferenceIdTypeEnum;
    /**
...
* @enum {string}
*/
export enum ItemReferenceIdTypeEnum {
    OrderProduct = 'ORDER_PRODUCT'
}

export function ItemReferenceIdFromJSON(json: any): ItemReferenceId {
    return ItemReferenceIdFromJSONTyped(json, false);
}

export function ItemReferenceIdFromJSONTyped(json: any, ignoreDiscriminator: boolean): ItemReferenceId {
...
export function ItemReferenceIdToJSON(value?: ItemReferenceId | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
