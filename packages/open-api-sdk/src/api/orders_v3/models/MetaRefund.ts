 ...
 * @export
 * @interface MetaRefund
 */
export interface MetaRefund {
    /**
     * 
     * @type {number}
     * @memberof MetaRefund
...
export function MetaRefundFromJSON(json: any): MetaRefund {
    return MetaRefundFromJSONTyped(json, false);
}

export function MetaRefundFromJSONTyped(json: any, ignoreDiscriminator: boolean): MetaRefund {
...
export function MetaRefundToJSON(value?: MetaRefund | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
