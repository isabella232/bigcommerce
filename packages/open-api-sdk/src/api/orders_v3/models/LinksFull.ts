...
export function LinksFullFromJSON(json: any): LinksFull {
    return LinksFullFromJSONTyped(json, false);
}

export function LinksFullFromJSONTyped(json: any, ignoreDiscriminator: boolean): LinksFull {
...
export function LinksFullToJSON(value?: LinksFull | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
