 ...
 * 
 * @export
 * @interface MetafieldAllOf
 */
export interface MetafieldAllOf {
    /**
     * The unique identifier for the metafields.
     * @type {number}
     * @memberof MetafieldAllOf
     */
    id?: number;
    /**
...
export function MetafieldAllOfFromJSON(json: any): MetafieldAllOf {
    return MetafieldAllOfFromJSONTyped(json, false);
}

export function MetafieldAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): MetafieldAllOf {
...
export function MetafieldAllOfToJSON(value?: MetafieldAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
