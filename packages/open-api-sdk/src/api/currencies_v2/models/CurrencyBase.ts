...
export function CurrencyBaseFromJSON(json: any): CurrencyBase {
    return CurrencyBaseFromJSONTyped(json, false);
}

export function CurrencyBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CurrencyBase {
...
export function CurrencyBaseToJSON(value?: CurrencyBase | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
