...
export function SitePutFromJSON(json: any): SitePut {
    return SitePutFromJSONTyped(json, false);
}

export function SitePutFromJSONTyped(json: any, ignoreDiscriminator: boolean): SitePut {
...
export function SitePutToJSON(value?: SitePut | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
