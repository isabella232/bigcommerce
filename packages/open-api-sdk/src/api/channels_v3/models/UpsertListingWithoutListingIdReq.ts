 ...
 * @export
 * @interface UpsertListingWithoutListingIdReq
 */
export interface UpsertListingWithoutListingIdReq {
    /**
     * The ID of the product associated with this channel listing.
     * @type {number}
     * @memberof UpsertListingWithoutListingIdReq
     */
    productId: number;
    /**
...
export function UpsertListingWithoutListingIdReqFromJSON(json: any): UpsertListingWithoutListingIdReq {
    return UpsertListingWithoutListingIdReqFromJSONTyped(json, false);
}

export function UpsertListingWithoutListingIdReqFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpsertListingWithoutListingIdReq {
...
export function UpsertListingWithoutListingIdReqToJSON(value?: UpsertListingWithoutListingIdReq | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
