...
import {
    ...
    MetaWithPartialPaginationFromJSON,
    MetaWithPartialPaginationFromJSONTyped,
    MetaWithPartialPaginationToJSON,
} from './';
...
export interface InlineResponse2007 {
    ...
    /**
     * 
     * @type {MetaWithPartialPagination}
     * @memberof InlineResponse2007
     */
...
export function InlineResponse2007FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse2007 {
    ...
    return {
        ...
        'data': !exists(json, 'data') ? undefined : ((json['data'] as Array<any>).map(ListingFromJSON)),
        'meta': !exists(json, 'meta') ? undefined : MetaWithPartialPaginationFromJSON(json['meta']),
    };
}
...
export function InlineResponse2007ToJSON(value?: InlineResponse2007 | null): any {
    ...
    return {
        ...
        'data': value.data === undefined ? undefined : ((value.data as Array<any>).map(ListingToJSON)),
        'meta': MetaWithPartialPaginationToJSON(value.meta),
    };
}
