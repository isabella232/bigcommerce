...
import {
    ...
    ChannelWithCurrenciesFromJSON,
    ChannelWithCurrenciesFromJSONTyped,
    ChannelWithCurrenciesToJSON,
} from './';
...
export function InlineResponse2002FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse2002 {
    ...
    return {
        ...
        'data': !exists(json, 'data') ? undefined : ChannelWithCurrenciesFromJSON(json['data']),
...
export function InlineResponse2002ToJSON(value?: InlineResponse2002 | null): any {
    ...
    return {
        ...
        'data': ChannelWithCurrenciesToJSON(value.data),
        'meta': value.meta,
    };
}
