 ...
 * 
 * @export
 * @interface CreateChannelReq
 */
export interface CreateChannelReq {
    /**
     * 
     * @type {ChannelConfigMeta}
     * @memberof CreateChannelReq
     */
...
export function CreateChannelReqFromJSON(json: any): CreateChannelReq {
    return CreateChannelReqFromJSONTyped(json, false);
}

export function CreateChannelReqFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateChannelReq {
...
export function CreateChannelReqToJSON(value?: CreateChannelReq | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
