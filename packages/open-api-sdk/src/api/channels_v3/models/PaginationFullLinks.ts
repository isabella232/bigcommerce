 ...
 * @export
 * @interface PaginationFullLinks
 */
export interface PaginationFullLinks {
    /**
     * Link to the previous page returned in the response.
     * @type {string}
     * @memberof PaginationFullLinks
     */
    previous?: string;
    /**
...
export function PaginationFullLinksFromJSON(json: any): PaginationFullLinks {
    return PaginationFullLinksFromJSONTyped(json, false);
}

export function PaginationFullLinksFromJSONTyped(json: any, ignoreDiscriminator: boolean): PaginationFullLinks {
...
export function PaginationFullLinksToJSON(value?: PaginationFullLinks | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
