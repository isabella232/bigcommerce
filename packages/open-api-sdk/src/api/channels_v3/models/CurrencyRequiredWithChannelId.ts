 ...
 * @export
 * @interface CurrencyRequiredWithChannelId
 */
export interface CurrencyRequiredWithChannelId {
    /**
     * The ID of the channel.
     * @type {number}
     * @memberof CurrencyRequiredWithChannelId
     */
    channelId: number;
    /**
...
export function CurrencyRequiredWithChannelIdFromJSON(json: any): CurrencyRequiredWithChannelId {
    return CurrencyRequiredWithChannelIdFromJSONTyped(json, false);
}

export function CurrencyRequiredWithChannelIdFromJSONTyped(json: any, ignoreDiscriminator: boolean): CurrencyRequiredWithChannelId {
    ...
    return {
        ...
        'enabledCurrencies': json['enabled_currencies'],
        'defaultCurrency': json['default_currency'],
    };
}

export function CurrencyRequiredWithChannelIdToJSON(value?: CurrencyRequiredWithChannelId | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
