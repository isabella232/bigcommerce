 ...
 * @export
 * @interface CurrencyNotRequiredWithChannelId
 */
export interface CurrencyNotRequiredWithChannelId {
    /**
     * The ID of the channel.
     * @type {number}
     * @memberof CurrencyNotRequiredWithChannelId
     */
    channelId?: number;
    /**
...
export function CurrencyNotRequiredWithChannelIdFromJSON(json: any): CurrencyNotRequiredWithChannelId {
    return CurrencyNotRequiredWithChannelIdFromJSONTyped(json, false);
}

export function CurrencyNotRequiredWithChannelIdFromJSONTyped(json: any, ignoreDiscriminator: boolean): CurrencyNotRequiredWithChannelId {
    ...
    return {
        ...
        'enabledCurrencies': !exists(json, 'enabled_currencies') ? undefined : json['enabled_currencies'],
        'defaultCurrency': !exists(json, 'default_currency') ? undefined : json['default_currency'],
    };
}

export function CurrencyNotRequiredWithChannelIdToJSON(value?: CurrencyNotRequiredWithChannelId | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'enabled_currencies': value.enabledCurrencies,
