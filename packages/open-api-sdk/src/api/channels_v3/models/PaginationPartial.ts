...
export function PaginationPartialFromJSON(json: any): PaginationPartial {
    return PaginationPartialFromJSONTyped(json, false);
}

export function PaginationPartialFromJSONTyped(json: any, ignoreDiscriminator: boolean): PaginationPartial {
...
export function PaginationPartialToJSON(value?: PaginationPartial | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
