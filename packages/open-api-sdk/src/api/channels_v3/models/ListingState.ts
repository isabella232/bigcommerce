...
export function ListingStateFromJSON(json: any): ListingState {
    return ListingStateFromJSONTyped(json, false);
}

export function ListingStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListingState {
    return json as ListingState;
}

export function ListingStateToJSON(value?: ListingState | null): any {
    return value as any;
}
