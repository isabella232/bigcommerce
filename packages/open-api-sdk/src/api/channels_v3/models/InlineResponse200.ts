...
import {
    ...
    ChannelWithoutCurrenciesFromJSON,
    ChannelWithoutCurrenciesFromJSONTyped,
    ChannelWithoutCurrenciesToJSON,
    MetaWithFullPagination,
    MetaWithFullPaginationFromJSON,
    MetaWithFullPaginationFromJSONTyped,
    MetaWithFullPaginationToJSON,
} from './';
...
export interface InlineResponse200 {
    /**
     * 
     * @type {Array<ChannelWithoutCurrencies>}
     * @memberof InlineResponse200
     */
    data?: Array<ChannelWithoutCurrencies>;
    /**
     * 
     * @type {MetaWithFullPagination}
     * @memberof InlineResponse200
     */
...
export function InlineResponse200FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200 {
    ...
    return {
        ...
        'data': !exists(json, 'data') ? undefined : ((json['data'] as Array<any>).map(ChannelWithoutCurrenciesFromJSON)),
        'meta': !exists(json, 'meta') ? undefined : MetaWithFullPaginationFromJSON(json['meta']),
    };
}
...
export function InlineResponse200ToJSON(value?: InlineResponse200 | null): any {
    ...
    return {
        ...
        'data': value.data === undefined ? undefined : ((value.data as Array<any>).map(ChannelWithoutCurrenciesToJSON)),
        'meta': MetaWithFullPaginationToJSON(value.meta),
    };
}
