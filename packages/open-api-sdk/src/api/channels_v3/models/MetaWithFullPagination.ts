 ...
 * @export
 * @interface MetaWithFullPagination
 */
export interface MetaWithFullPagination {
    /**
     * 
     * @type {PaginationFull}
     * @memberof MetaWithFullPagination
     */
    pagination?: PaginationFull;
}

export function MetaWithFullPaginationFromJSON(json: any): MetaWithFullPagination {
    return MetaWithFullPaginationFromJSONTyped(json, false);
}

export function MetaWithFullPaginationFromJSONTyped(json: any, ignoreDiscriminator: boolean): MetaWithFullPagination {
...
export function MetaWithFullPaginationToJSON(value?: MetaWithFullPagination | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
