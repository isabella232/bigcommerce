...
export function UpdateChannelReqFromJSON(json: any): UpdateChannelReq {
    return UpdateChannelReqFromJSONTyped(json, false);
}

export function UpdateChannelReqFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateChannelReq {
...
export function UpdateChannelReqToJSON(value?: UpdateChannelReq | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
