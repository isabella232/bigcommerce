...
export interface InlineResponse2004 {
    /**
     * 
     * @type {Array<CurrencyNotRequiredWithChannelId>}
...
export function InlineResponse2004FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse2004 {
    ...
    return {
        ...
        'data': !exists(json, 'data') ? undefined : ((json['data'] as Array<any>).map(CurrencyNotRequiredWithChannelIdFromJSON)),
...
export function InlineResponse2004ToJSON(value?: InlineResponse2004 | null): any {
    ...
    return {
        ...
        'data': value.data === undefined ? undefined : ((value.data as Array<any>).map(CurrencyNotRequiredWithChannelIdToJSON)),
        'meta': value.meta,
    };
}
