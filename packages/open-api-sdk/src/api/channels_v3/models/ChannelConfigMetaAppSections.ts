 ...
 * 
 * @export
 * @interface ChannelConfigMetaAppSections
 */
export interface ChannelConfigMetaAppSections {
    /**
     * The title of the navigation section.
     * @type {string}
     * @memberof ChannelConfigMetaAppSections
     */
    title?: string;
    /**
...
export function ChannelConfigMetaAppSectionsFromJSON(json: any): ChannelConfigMetaAppSections {
    return ChannelConfigMetaAppSectionsFromJSONTyped(json, false);
}

export function ChannelConfigMetaAppSectionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChannelConfigMetaAppSections {
    ...
    return {
        ...
        'queryPath': !exists(json, 'query_path') ? undefined : json['query_path'],
    };
}

export function ChannelConfigMetaAppSectionsToJSON(value?: ChannelConfigMetaAppSections | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
