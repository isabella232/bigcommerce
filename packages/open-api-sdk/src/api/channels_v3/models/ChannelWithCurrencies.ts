 ...
 * 
 * @export
 * @interface ChannelWithCurrencies
 */
export interface ChannelWithCurrencies {
    /**
     * 
     * @type {ChannelConfigMeta}
     * @memberof ChannelWithCurrencies
     */
...
export function ChannelWithCurrenciesFromJSON(json: any): ChannelWithCurrencies {
    return ChannelWithCurrenciesFromJSONTyped(json, false);
}

export function ChannelWithCurrenciesFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChannelWithCurrencies {
    ...
    return {
        ...
        'currencies': !exists(json, 'currencies') ? undefined : CurrencyNotRequiredWithChannelIdFromJSON(json['currencies']),
    };
}

export function ChannelWithCurrenciesToJSON(value?: ChannelWithCurrencies | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'currencies': CurrencyNotRequiredWithChannelIdToJSON(value.currencies),
    };
}
