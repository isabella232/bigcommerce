...
import {
    PaginationPartial,
    PaginationPartialFromJSON,
    PaginationPartialFromJSONTyped,
    PaginationPartialToJSON,
} from './';

/**
 * Data about the response, including pagination.
 * @export
 * @interface MetaWithPartialPagination
 */
export interface MetaWithPartialPagination {
    /**
     * 
     * @type {PaginationPartial}
     * @memberof MetaWithPartialPagination
     */
    pagination?: PaginationPartial;
}

export function MetaWithPartialPaginationFromJSON(json: any): MetaWithPartialPagination {
    return MetaWithPartialPaginationFromJSONTyped(json, false);
}

export function MetaWithPartialPaginationFromJSONTyped(json: any, ignoreDiscriminator: boolean): MetaWithPartialPagination {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'pagination': !exists(json, 'pagination') ? undefined : PaginationPartialFromJSON(json['pagination']),
    };
}

export function MetaWithPartialPaginationToJSON(value?: MetaWithPartialPagination | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'pagination': PaginationPartialToJSON(value.pagination),
    };
}
