...
export function VariantStateFromJSON(json: any): VariantState {
    return VariantStateFromJSONTyped(json, false);
}

export function VariantStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): VariantState {
    return json as VariantState;
}

export function VariantStateToJSON(value?: VariantState | null): any {
    return value as any;
}
