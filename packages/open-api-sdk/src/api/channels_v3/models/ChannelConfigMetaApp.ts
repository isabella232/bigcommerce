...
import {
    ...
    ChannelConfigMetaAppSectionsFromJSON,
    ChannelConfigMetaAppSectionsFromJSONTyped,
    ChannelConfigMetaAppSectionsToJSON,
} from './';
 ...
 * @export
 * @interface ChannelConfigMetaApp
 */
export interface ChannelConfigMetaApp {
    /**
     ...
     * @type {Array<ChannelConfigMetaAppSections>}
     * @memberof ChannelConfigMetaApp
     */
    sections?: Array<ChannelConfigMetaAppSections>;
}

export function ChannelConfigMetaAppFromJSON(json: any): ChannelConfigMetaApp {
    return ChannelConfigMetaAppFromJSONTyped(json, false);
}

export function ChannelConfigMetaAppFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChannelConfigMetaApp {
    ...
    return {
        ...
        'sections': !exists(json, 'sections') ? undefined : ((json['sections'] as Array<any>).map(ChannelConfigMetaAppSectionsFromJSON)),
    };
}

export function ChannelConfigMetaAppToJSON(value?: ChannelConfigMetaApp | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'id': value.id,
        'sections': value.sections === undefined ? undefined : ((value.sections as Array<any>).map(ChannelConfigMetaAppSectionsToJSON)),
    };
}
