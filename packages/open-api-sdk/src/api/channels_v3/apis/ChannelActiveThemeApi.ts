...
export interface GetChannelActiveThemeRequest {
    channelId: number;
}
 ...
 * 
 */
export class ChannelActiveThemeApi extends runtime.BaseAPI {

    /**
     * Returns active theme details for a specific channel.
     * Get a Channel Active Theme
     */
    async getChannelActiveThemeRaw(requestParameters: GetChannelActiveThemeRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<InlineResponse2003>> {
        if (requestParameters.channelId === null || requestParameters.channelId === undefined) {
            throw new runtime.RequiredError('channelId','Required parameter requestParameters.channelId was null or undefined when calling getChannelActiveTheme.');
        }
        ...
        const response = await this.request({
            path: `/channels/{channel_id}/active-theme`.replace(`{${"channel_id"}}`, encodeURIComponent(String(requestParameters.channelId))),
            method: 'GET',
     ...
     * Get a Channel Active Theme
     */
    async getChannelActiveTheme(requestParameters: GetChannelActiveThemeRequest, initOverrides?: RequestInit): Promise<InlineResponse2003> {
        const response = await this.getChannelActiveThemeRaw(requestParameters, initOverrides);
