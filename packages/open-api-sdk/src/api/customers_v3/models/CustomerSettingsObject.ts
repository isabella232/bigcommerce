...
import {
    ...
    CustomerSettingsObjectPrivacySettingsFromJSON,
    CustomerSettingsObjectPrivacySettingsFromJSONTyped,
    CustomerSettingsObjectPrivacySettingsToJSON,
} from './';

/**
 * Customer Settings
 * @export
 * @interface CustomerSettingsObject
 */
export interface CustomerSettingsObject {
    /**
     * 
     * @type {CustomerSettingsObjectPrivacySettings}
     * @memberof CustomerSettingsObject
     */
    privacySettings?: CustomerSettingsObjectPrivacySettings;
    /**
     * 
...
export function CustomerSettingsObjectFromJSON(json: any): CustomerSettingsObject {
    return CustomerSettingsObjectFromJSONTyped(json, false);
}

export function CustomerSettingsObjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomerSettingsObject {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'privacySettings': !exists(json, 'privacy_settings') ? undefined : CustomerSettingsObjectPrivacySettingsFromJSON(json['privacy_settings']),
...
export function CustomerSettingsObjectToJSON(value?: CustomerSettingsObject | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'privacy_settings': CustomerSettingsObjectPrivacySettingsToJSON(value.privacySettings),
