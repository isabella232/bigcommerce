...
export function CustomerPutFromJSON(json: any): CustomerPut {
    return CustomerPutFromJSONTyped(json, false);
}

export function CustomerPutFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomerPut {
...
export function CustomerPutToJSON(value?: CustomerPut | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
