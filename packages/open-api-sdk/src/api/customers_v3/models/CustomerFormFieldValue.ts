...
export interface CustomerFormFieldValue {
     ...
     * The form field name.
     * @type {string}
     * @memberof CustomerFormFieldValue
     */
    name: string;
    /**
     * 
...
export function CustomerFormFieldValueFromJSON(json: any): CustomerFormFieldValue {
    return CustomerFormFieldValueFromJSONTyped(json, false);
}

export function CustomerFormFieldValueFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomerFormFieldValue {
...
export function CustomerFormFieldValueToJSON(value?: CustomerFormFieldValue | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
