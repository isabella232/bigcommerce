...
export function Links1FromJSON(json: any): Links1 {
    return Links1FromJSONTyped(json, false);
}

export function Links1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Links1 {
...
export function Links1ToJSON(value?: Links1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
