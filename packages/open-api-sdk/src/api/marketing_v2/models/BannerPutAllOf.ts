 ...
 * 
 * @export
 * @interface BannerPutAllOf
 */
export interface BannerPutAllOf {
    /**
     * If the banner is on a specific category or brand page then the `item_id` will correspond the category or brand id.
     * @type {string}
     * @memberof BannerPutAllOf
     */
    itemId?: string;
}

export function BannerPutAllOfFromJSON(json: any): BannerPutAllOf {
    return BannerPutAllOfFromJSONTyped(json, false);
}

export function BannerPutAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): BannerPutAllOf {
...
export function BannerPutAllOfToJSON(value?: BannerPutAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
