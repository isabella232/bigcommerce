...
import {
    ...
    GiftCertificatePutAllOf,
    GiftCertificatePutAllOfFromJSON,
    GiftCertificatePutAllOfFromJSONTyped,
    GiftCertificatePutAllOfToJSON,
} from './';

/**
 * 
 * @export
 * @interface GiftCertificatePut
 */
export interface GiftCertificatePut {
    /**
     * Name of the recipient.
     * @type {string}
     * @memberof GiftCertificatePut
     */
    toName: string;
    /**
     ...
     * @memberof GiftCertificatePut
     */
    template?: GiftCertificatePutTemplateEnum;
    /**
     ...
     * @memberof GiftCertificatePut
     */
    status?: GiftCertificatePutStatusEnum;
}
...
* @enum {string}
*/
export enum GiftCertificatePutTemplateEnum {
    Birthday = 'Birthday',
    Boy = 'Boy',
    Girl = 'Girl',
...
* @enum {string}
*/
export enum GiftCertificatePutStatusEnum {
    Active = 'active',
    Pending = 'pending',
    Expired = 'expired',
    Disabled = 'disabled'
...
export function GiftCertificatePutFromJSON(json: any): GiftCertificatePut {
    return GiftCertificatePutFromJSONTyped(json, false);
}

export function GiftCertificatePutFromJSONTyped(json: any, ignoreDiscriminator: boolean): GiftCertificatePut {
...
export function GiftCertificatePutToJSON(value?: GiftCertificatePut | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
