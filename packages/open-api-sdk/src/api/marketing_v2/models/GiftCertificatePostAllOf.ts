 ...
 * 
 * @export
 * @interface GiftCertificatePostAllOf
 */
export interface GiftCertificatePostAllOf {
    /**
     * Remaining value of the gift certificate. If not set, will default to the amount.
     * @type {string}
     * @memberof GiftCertificatePostAllOf
     */
    balance?: string;
    /**
     ...
     * @memberof GiftCertificatePostAllOf
     */
    template?: GiftCertificatePostAllOfTemplateEnum;
    /**
     ...
     * @memberof GiftCertificatePostAllOf
     */
    status?: GiftCertificatePostAllOfStatusEnum;
    /**
...
* @enum {string}
*/
export enum GiftCertificatePostAllOfTemplateEnum {
    Birthday = 'Birthday',
    Boy = 'Boy',
    Girl = 'Girl',
...
* @enum {string}
*/
export enum GiftCertificatePostAllOfStatusEnum {
    Active = 'active',
    Pending = 'pending',
    Expired = 'expired',
    Disabled = 'disabled'
...
export function GiftCertificatePostAllOfFromJSON(json: any): GiftCertificatePostAllOf {
    return GiftCertificatePostAllOfFromJSONTyped(json, false);
}

export function GiftCertificatePostAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): GiftCertificatePostAllOf {
...
export function GiftCertificatePostAllOfToJSON(value?: GiftCertificatePostAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
