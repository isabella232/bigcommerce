...
import {
    OrderCouponsBase,
    OrderCouponsBaseFromJSON,
    OrderCouponsBaseToJSON,
} from '../models';

export interface GetAllOrderCouponsRequest {
    orderId: number;
    accept: string;
    contentType: string;
    page?: number;
 ...
 * 
 */
export class OrderCouponsApi extends runtime.BaseAPI {
     ...
     * List Order Coupons
     */
    async getAllOrderCouponsRaw(requestParameters: GetAllOrderCouponsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Array<OrderCouponsBase>>> {
        if (requestParameters.orderId === null || requestParameters.orderId === undefined) {
            throw new runtime.RequiredError('orderId','Required parameter requestParameters.orderId was null or undefined when calling getAllOrderCoupons.');
        }

        if (requestParameters.accept === null || requestParameters.accept === undefined) {
            throw new runtime.RequiredError('accept','Required parameter requestParameters.accept was null or undefined when calling getAllOrderCoupons.');
        }

        if (requestParameters.contentType === null || requestParameters.contentType === undefined) {
            throw new runtime.RequiredError('contentType','Required parameter requestParameters.contentType was null or undefined when calling getAllOrderCoupons.');
        }
        ...
        const response = await this.request({
            path: `/orders/{order_id}/coupons`.replace(`{${"order_id"}}`, encodeURIComponent(String(requestParameters.orderId))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(OrderCouponsBaseFromJSON));
    }
     ...
     * List Order Coupons
     */
    async getAllOrderCoupons(requestParameters: GetAllOrderCouponsRequest, initOverrides?: RequestInit): Promise<Array<OrderCouponsBase>> {
        const response = await this.getAllOrderCouponsRaw(requestParameters, initOverrides);
