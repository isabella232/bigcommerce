...
import {
    ...
    NullFromJSONTyped,
    NullToJSON,
    OrderCatalogProductPut,
    OrderCatalogProductPutFromJSON,
    OrderCatalogProductPutFromJSONTyped,
    OrderCatalogProductPutToJSON,
    OrderCustomProductPut,
    OrderCustomProductPutFromJSON,
    OrderCustomProductPutFromJSONTyped,
    OrderCustomProductPutToJSON,
    OrderPutAllOf,
    OrderPutAllOfFromJSON,
    OrderPutAllOfFromJSONTyped,
    OrderPutAllOfToJSON,
    OrderShared,
    OrderSharedFromJSON,
...
export interface OrderPut {
    /**
     * 
     * @type {Array<OrderCatalogProductPut | OrderCustomProductPut>}
     * @memberof OrderPut
     */
    products?: Array<OrderCatalogProductPut | OrderCustomProductPut>;
    /**
     * 
     * @type {ShippingAddressBase}
     * @memberof OrderPut
     */
    shippingAddresses?: ShippingAddressBase;
    /**
     ...
     * @memberof OrderPut
     */
    paymentMethod?: OrderPutPaymentMethodEnum;
    /**
     ...
     * @memberof OrderPut
     */
    taxProviderId?: OrderPutTaxProviderIdEnum;
    /**
...
* @enum {string}
*/
export enum OrderPutPaymentMethodEnum {
...
* @enum {string}
*/
export enum OrderPutTaxProviderIdEnum {
    BasicTaxProvider = 'BasicTaxProvider',
    AvaTaxProvider = 'AvaTaxProvider',
    Empty = ''
}

export function OrderPutFromJSON(json: any): OrderPut {
    return OrderPutFromJSONTyped(json, false);
}

export function OrderPutFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderPut {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'products': !exists(json, 'products') ? undefined : ((json['products'] as Array<any>).map(OrderCatalogProductPut | OrderCustomProductPutFromJSON)),
        'shippingAddresses': !exists(json, 'shipping_addresses') ? undefined : ShippingAddressBaseFromJSON(json['shipping_addresses']),
...
export function OrderPutToJSON(value?: OrderPut | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'products': value.products === undefined ? undefined : ((value.products as Array<any>).map(OrderCatalogProductPut | OrderCustomProductPutToJSON)),
        'shipping_addresses': ShippingAddressBaseToJSON(value.shippingAddresses),
