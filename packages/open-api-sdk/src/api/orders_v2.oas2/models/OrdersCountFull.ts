...
import {
    OrdersCountStatus,
    OrdersCountStatusFromJSON,
    OrdersCountStatusFromJSONTyped,
    OrdersCountStatusToJSON,
} from './';

/**
 * 
 * @export
 * @interface OrdersCountFull
 */
export interface OrdersCountFull {
    /**
     * 
     * @type {Array<OrdersCountStatus>}
     * @memberof OrdersCountFull
     */
...
export function OrdersCountFullFromJSON(json: any): OrdersCountFull {
    return OrdersCountFullFromJSONTyped(json, false);
}

export function OrdersCountFullFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrdersCountFull {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'statuses': !exists(json, 'statuses') ? undefined : ((json['statuses'] as Array<any>).map(OrdersCountStatusFromJSON)),
        'count': !exists(json, 'count') ? undefined : json['count'],
    };
}

export function OrdersCountFullToJSON(value?: OrdersCountFull | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'statuses': value.statuses === undefined ? undefined : ((value.statuses as Array<any>).map(OrdersCountStatusToJSON)),
        'count': value.count,
    };
}
