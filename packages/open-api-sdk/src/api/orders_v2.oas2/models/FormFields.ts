...
export function FormFieldsFromJSON(json: any): FormFields {
    return FormFieldsFromJSONTyped(json, false);
}

export function FormFieldsFromJSONTyped(json: any, ignoreDiscriminator: boolean): FormFields {
...
export function FormFieldsToJSON(value?: FormFields | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
