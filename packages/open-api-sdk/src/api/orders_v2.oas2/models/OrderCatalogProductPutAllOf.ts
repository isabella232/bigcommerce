 ...
 * 
 * @export
 * @interface OrderCatalogProductPutAllOf
 */
export interface OrderCatalogProductPutAllOf {
    /**
     ...
     * @type {number}
     * @memberof OrderCatalogProductPutAllOf
     */
    id?: number;
}

export function OrderCatalogProductPutAllOfFromJSON(json: any): OrderCatalogProductPutAllOf {
    return OrderCatalogProductPutAllOfFromJSONTyped(json, false);
}

export function OrderCatalogProductPutAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderCatalogProductPutAllOf {
...
export function OrderCatalogProductPutAllOfToJSON(value?: OrderCatalogProductPutAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
