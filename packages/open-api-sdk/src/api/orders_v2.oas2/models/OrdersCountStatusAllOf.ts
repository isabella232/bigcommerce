 ...
 * 
 * @export
 * @interface OrdersCountStatusAllOf
 */
export interface OrdersCountStatusAllOf {
    /**
     * Number of orders that exist with this status
     * @type {number}
     * @memberof OrdersCountStatusAllOf
     */
    count?: number;
    /**
...
export function OrdersCountStatusAllOfFromJSON(json: any): OrdersCountStatusAllOf {
    return OrdersCountStatusAllOfFromJSONTyped(json, false);
}

export function OrdersCountStatusAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrdersCountStatusAllOf {
...
export function OrdersCountStatusAllOfToJSON(value?: OrdersCountStatusAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
