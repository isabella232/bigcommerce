 ...
 * 
 * @export
 * @interface OrderPutAllOf
 */
export interface OrderPutAllOf {
    /**
     * 
     * @type {Array<OrderCatalogProductPut | OrderCustomProductPut>}
     * @memberof OrderPutAllOf
     */
...
export function OrderPutAllOfFromJSON(json: any): OrderPutAllOf {
    return OrderPutAllOfFromJSONTyped(json, false);
}

export function OrderPutAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderPutAllOf {
...
export function OrderPutAllOfToJSON(value?: OrderPutAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
