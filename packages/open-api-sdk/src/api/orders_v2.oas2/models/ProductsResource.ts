...
export function ProductsResourceFromJSON(json: any): ProductsResource {
    return ProductsResourceFromJSONTyped(json, false);
}

export function ProductsResourceFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductsResource {
...
export function ProductsResourceToJSON(value?: ProductsResource | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
