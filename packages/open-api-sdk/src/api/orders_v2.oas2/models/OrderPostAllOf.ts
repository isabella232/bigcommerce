 ...
 * 
 * @export
 * @interface OrderPostAllOf
 */
export interface OrderPostAllOf {
    /**
     * 
     * @type {Array<OrderCustomProductPost | OrderCatalogProductPost>}
     * @memberof OrderPostAllOf
     */
...
export function OrderPostAllOfFromJSON(json: any): OrderPostAllOf {
    return OrderPostAllOfFromJSONTyped(json, false);
}

export function OrderPostAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderPostAllOf {
...
export function OrderPostAllOfToJSON(value?: OrderPostAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
