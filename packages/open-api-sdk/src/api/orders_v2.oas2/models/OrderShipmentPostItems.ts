 ...
 * 
 * @export
 * @interface OrderShipmentPostItems
 */
export interface OrderShipmentPostItems {
    /**
     * 
     * @type {number}
     * @memberof OrderShipmentPostItems
     */
...
export function OrderShipmentPostItemsFromJSON(json: any): OrderShipmentPostItems {
    return OrderShipmentPostItemsFromJSONTyped(json, false);
}

export function OrderShipmentPostItemsFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderShipmentPostItems {
...
export function OrderShipmentPostItemsToJSON(value?: OrderShipmentPostItems | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
