 ...
 * 
 * @export
 * @interface ShippingAddressesResource
 */
export interface ShippingAddressesResource {
    /**
     * URL of the shipping address for api requests
     * @type {string}
     * @memberof ShippingAddressesResource
     */
    readonly url?: string;
    /**
     * 
...
export function ShippingAddressesResourceFromJSON(json: any): ShippingAddressesResource {
    return ShippingAddressesResourceFromJSONTyped(json, false);
}

export function ShippingAddressesResourceFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShippingAddressesResource {
...
export function ShippingAddressesResourceToJSON(value?: ShippingAddressesResource | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
