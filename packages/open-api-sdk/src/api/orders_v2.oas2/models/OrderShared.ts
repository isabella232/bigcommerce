...
export interface OrderShared {
     ...
     * @memberof OrderShared
     */
    paymentMethod?: OrderSharedPaymentMethodEnum;
    /**
     ...
     * @memberof OrderShared
     */
    taxProviderId?: OrderSharedTaxProviderIdEnum;
    /**
...
* @enum {string}
*/
export enum OrderSharedPaymentMethodEnum {
...
* @enum {string}
*/
export enum OrderSharedTaxProviderIdEnum {
    BasicTaxProvider = 'BasicTaxProvider',
    AvaTaxProvider = 'AvaTaxProvider',
    Empty = ''
}

export function OrderSharedFromJSON(json: any): OrderShared {
    return OrderSharedFromJSONTyped(json, false);
}

export function OrderSharedFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderShared {
...
export function OrderSharedToJSON(value?: OrderShared | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
