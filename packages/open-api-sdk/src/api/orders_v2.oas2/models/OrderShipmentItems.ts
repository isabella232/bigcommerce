 ...
 * 
 * @export
 * @interface OrderShipmentItems
 */
export interface OrderShipmentItems {
    /**
     * 
     * @type {number}
     * @memberof OrderShipmentItems
     */
...
export function OrderShipmentItemsFromJSON(json: any): OrderShipmentItems {
    return OrderShipmentItemsFromJSONTyped(json, false);
}

export function OrderShipmentItemsFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderShipmentItems {
...
export function OrderShipmentItemsToJSON(value?: OrderShipmentItems | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
