...
export function OrderStatusBaseFromJSON(json: any): OrderStatusBase {
    return OrderStatusBaseFromJSONTyped(json, false);
}

export function OrderStatusBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderStatusBase {
...
export function OrderStatusBaseToJSON(value?: OrderStatusBase | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
