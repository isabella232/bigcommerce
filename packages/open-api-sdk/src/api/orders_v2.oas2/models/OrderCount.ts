...
export function OrderCountFromJSON(json: any): OrderCount {
    return OrderCountFromJSONTyped(json, false);
}

export function OrderCountFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderCount {
...
export function OrderCountToJSON(value?: OrderCount | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
