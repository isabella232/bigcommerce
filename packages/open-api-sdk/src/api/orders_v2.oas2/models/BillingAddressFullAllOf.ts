 ...
 * 
 * @export
 * @interface BillingAddressFullAllOf
 */
export interface BillingAddressFullAllOf {
    /**
     * 
     * @type {Array<FormFields>}
     * @memberof BillingAddressFullAllOf
     */
    formFields?: Array<FormFields>;
}

export function BillingAddressFullAllOfFromJSON(json: any): BillingAddressFullAllOf {
    return BillingAddressFullAllOfFromJSONTyped(json, false);
}

export function BillingAddressFullAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): BillingAddressFullAllOf {
...
export function BillingAddressFullAllOfToJSON(value?: BillingAddressFullAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
