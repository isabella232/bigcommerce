 ...
 * 
 * @export
 * @interface ShippingQuotesResource
 */
export interface ShippingQuotesResource {
    /**
     ...
     * @type {string}
     * @memberof ShippingQuotesResource
     */
    readonly url?: string;
    /**
     * This URL will return a 204 for shipping quotes. To return shipping quotes:
...
export function ShippingQuotesResourceFromJSON(json: any): ShippingQuotesResource {
    return ShippingQuotesResourceFromJSONTyped(json, false);
}

export function ShippingQuotesResourceFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShippingQuotesResource {
...
export function ShippingQuotesResourceToJSON(value?: ShippingQuotesResource | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
