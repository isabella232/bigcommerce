...
export function InlineResponse4221FromJSON(json: any): InlineResponse4221 {
    return InlineResponse4221FromJSONTyped(json, false);
}

export function InlineResponse4221FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse4221 {
...
export function InlineResponse4221ToJSON(value?: InlineResponse4221 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
