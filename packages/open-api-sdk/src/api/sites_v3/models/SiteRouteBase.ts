 ...
 * 
 * @export
 * @interface SiteRouteBase
 */
export interface SiteRouteBase {
    /**
     ...
     * @type {string}
     * @memberof SiteRouteBase
     */
    type?: SiteRouteBaseTypeEnum;
    /**
...
* @enum {string}
*/
export enum SiteRouteBaseTypeEnum {
    Product = 'product',
    Brand = 'brand',
    Category = 'category',
    Page = 'page',
...
export function SiteRouteBaseFromJSON(json: any): SiteRouteBase {
    return SiteRouteBaseFromJSONTyped(json, false);
}

export function SiteRouteBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SiteRouteBase {
...
export function SiteRouteBaseToJSON(value?: SiteRouteBase | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
