 ...
 * 
 * @export
 * @interface SiteRoutesRouteBase
 */
export interface SiteRoutesRouteBase {
    /**
     ...
     * @type {string}
     * @memberof SiteRoutesRouteBase
     */
    type: SiteRoutesRouteBaseTypeEnum;
    /**
...
* @enum {string}
*/
export enum SiteRoutesRouteBaseTypeEnum {
    Product = 'product',
    Brand = 'brand',
    Category = 'category',
    Page = 'page',
...
export function SiteRoutesRouteBaseFromJSON(json: any): SiteRoutesRouteBase {
    return SiteRoutesRouteBaseFromJSONTyped(json, false);
}

export function SiteRoutesRouteBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SiteRoutesRouteBase {
...
export function SiteRoutesRouteBaseToJSON(value?: SiteRoutesRouteBase | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
