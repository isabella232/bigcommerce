...
export function PutSiteFromJSON(json: any): PutSite {
    return PutSiteFromJSONTyped(json, false);
}

export function PutSiteFromJSONTyped(json: any, ignoreDiscriminator: boolean): PutSite {
...
export function PutSiteToJSON(value?: PutSite | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
