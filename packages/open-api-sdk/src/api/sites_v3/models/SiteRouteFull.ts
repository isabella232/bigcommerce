...
import {
    ...
    SiteRouteBaseFromJSONTyped,
    SiteRouteBaseToJSON,
    SiteRouteFullAllOf,
    SiteRouteFullAllOfFromJSON,
    SiteRouteFullAllOfFromJSONTyped,
    SiteRouteFullAllOfToJSON,
} from './';

/**
 * Route object used in responses.
 * @export
 * @interface SiteRouteFull
 */
export interface SiteRouteFull {
    /**
     * Unique ID for this route. Required when updating an existing route.
     * @type {number}
     * @memberof SiteRouteFull
     */
    id?: number;
    /**
...
* @enum {string}
*/
export enum SiteRouteFullTypeEnum {
    Product = 'product',
    Brand = 'brand',
    Category = 'category',
    Page = 'page',
...
export function SiteRouteFullFromJSON(json: any): SiteRouteFull {
    return SiteRouteFullFromJSONTyped(json, false);
}

export function SiteRouteFullFromJSONTyped(json: any, ignoreDiscriminator: boolean): SiteRouteFull {
...
export function SiteRouteFullToJSON(value?: SiteRouteFull | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
