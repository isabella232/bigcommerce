...
export function PostSiteFromJSON(json: any): PostSite {
    return PostSiteFromJSONTyped(json, false);
}

export function PostSiteFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostSite {
...
export function PostSiteToJSON(value?: PostSite | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
