 ...
 * 
 * @export
 * @interface SiteRouteFullAllOf
 */
export interface SiteRouteFullAllOf {
    /**
     * Unique ID for this route. Required when updating an existing route.
     * @type {number}
     * @memberof SiteRouteFullAllOf
     */
    id?: number;
}

export function SiteRouteFullAllOfFromJSON(json: any): SiteRouteFullAllOf {
    return SiteRouteFullAllOfFromJSONTyped(json, false);
}

export function SiteRouteFullAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): SiteRouteFullAllOf {
...
export function SiteRouteFullAllOfToJSON(value?: SiteRouteFullAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
