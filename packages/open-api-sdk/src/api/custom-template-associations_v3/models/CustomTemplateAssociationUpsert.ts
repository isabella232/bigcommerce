 ...
 * 
 * @export
 * @interface CustomTemplateAssociationUpsert
 */
export interface CustomTemplateAssociationUpsert {
    /**
     * 
     * @type {number}
     * @memberof CustomTemplateAssociationUpsert
     */
    channelId: number;
    /**
     * 
     ...
     * @memberof CustomTemplateAssociationUpsert
     */
    entityType: CustomTemplateAssociationUpsertEntityTypeEnum;
    /**
     * 
     * @type {number}
     * @memberof CustomTemplateAssociationUpsert
...
* @enum {string}
*/
export enum CustomTemplateAssociationUpsertEntityTypeEnum {
    Product = 'product',
    Category = 'category',
    Brand = 'brand',
    Page = 'page'
...
export function CustomTemplateAssociationUpsertFromJSON(json: any): CustomTemplateAssociationUpsert {
    return CustomTemplateAssociationUpsertFromJSONTyped(json, false);
}

export function CustomTemplateAssociationUpsertFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomTemplateAssociationUpsert {
...
export function CustomTemplateAssociationUpsertToJSON(value?: CustomTemplateAssociationUpsert | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
