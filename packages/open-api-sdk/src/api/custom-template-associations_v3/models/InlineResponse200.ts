...
import {
    ...
    CustomTemplateAssociationFromJSON,
    CustomTemplateAssociationFromJSONTyped,
    CustomTemplateAssociationToJSON,
...
export interface InlineResponse200 {
    /**
     * 
     * @type {Array<CustomTemplateAssociation>}
...
export function InlineResponse200FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200 {
    ...
    return {
        ...
        'data': !exists(json, 'data') ? undefined : ((json['data'] as Array<any>).map(CustomTemplateAssociationFromJSON)),
...
export function InlineResponse200ToJSON(value?: InlineResponse200 | null): any {
    ...
    return {
        ...
        'data': value.data === undefined ? undefined : ((value.data as Array<any>).map(CustomTemplateAssociationToJSON)),
