 ...
 * * Update a PriceList
 * @export
 * @interface PriceListResponse1
 */
export interface PriceListResponse1 {
    /**
     * 
     * @type {PriceList}
     * @memberof PriceListResponse1
     */
    data?: PriceList;
    /**
...
export function PriceListResponse1FromJSON(json: any): PriceListResponse1 {
    return PriceListResponse1FromJSONTyped(json, false);
}

export function PriceListResponse1FromJSONTyped(json: any, ignoreDiscriminator: boolean): PriceListResponse1 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'data': !exists(json, 'data') ? undefined : PriceListFromJSON(json['data']),
        'meta': !exists(json, 'meta') ? undefined : json['meta'],
    };
}

export function PriceListResponse1ToJSON(value?: PriceListResponse1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'data': PriceListToJSON(value.data),
        'meta': value.meta,
    };
}
