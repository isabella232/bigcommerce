...
import {
    ...
    PriceListAssignmentsBatchErrorSetFromJSON,
    PriceListAssignmentsBatchErrorSetFromJSONTyped,
    PriceListAssignmentsBatchErrorSetToJSON,
} from './';

/**
 * Errors during batch usage for the BigCommerce API.
 * @export
 * @interface PriceListAssignmentsBatchErrorResponse
 */
export interface PriceListAssignmentsBatchErrorResponse {
    /**
     * 
     * @type {Array<PriceListAssignmentsBatchErrorSet>}
     * @memberof PriceListAssignmentsBatchErrorResponse
     */
    batchErrors?: Array<PriceListAssignmentsBatchErrorSet>;
}

export function PriceListAssignmentsBatchErrorResponseFromJSON(json: any): PriceListAssignmentsBatchErrorResponse {
    return PriceListAssignmentsBatchErrorResponseFromJSONTyped(json, false);
}

export function PriceListAssignmentsBatchErrorResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PriceListAssignmentsBatchErrorResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'batchErrors': !exists(json, 'batch_errors') ? undefined : ((json['batch_errors'] as Array<any>).map(PriceListAssignmentsBatchErrorSetFromJSON)),
    };
}

export function PriceListAssignmentsBatchErrorResponseToJSON(value?: PriceListAssignmentsBatchErrorResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'batch_errors': value.batchErrors === undefined ? undefined : ((value.batchErrors as Array<any>).map(PriceListAssignmentsBatchErrorSetToJSON)),
    };
}
