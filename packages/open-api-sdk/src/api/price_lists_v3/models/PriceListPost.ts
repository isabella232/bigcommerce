...
import {
    PriceListBase,
    PriceListBaseFromJSON,
    PriceListBaseFromJSONTyped,
    PriceListBaseToJSON,
} from './';
 ...
 * @export
 * @interface PriceListPost
 */
export interface PriceListPost {
    /**
     * The unique name of the Price List. Required in /POST. 
     * @type {string}
     * @memberof PriceListPost
     */
    name: string;
    /**
...
export function PriceListPostFromJSON(json: any): PriceListPost {
    return PriceListPostFromJSONTyped(json, false);
}

export function PriceListPostFromJSONTyped(json: any, ignoreDiscriminator: boolean): PriceListPost {
...
export function PriceListPostToJSON(value?: PriceListPost | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
