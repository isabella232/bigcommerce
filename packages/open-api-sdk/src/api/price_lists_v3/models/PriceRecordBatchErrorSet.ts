 ...
 * @export
 * @interface PriceRecordBatchErrorSet
 */
export interface PriceRecordBatchErrorSet {
    /**
     * Price Record object used in batch create or update.
     * @type {object}
     * @memberof PriceRecordBatchErrorSet
     */
    data?: object;
    /**
     * 
...
export function PriceRecordBatchErrorSetFromJSON(json: any): PriceRecordBatchErrorSet {
    return PriceRecordBatchErrorSetFromJSONTyped(json, false);
}

export function PriceRecordBatchErrorSetFromJSONTyped(json: any, ignoreDiscriminator: boolean): PriceRecordBatchErrorSet {
...
export function PriceRecordBatchErrorSetToJSON(value?: PriceRecordBatchErrorSet | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
