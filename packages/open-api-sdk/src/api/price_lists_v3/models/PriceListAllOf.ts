 ...
 * 
 * @export
 * @interface PriceListAllOf
 */
export interface PriceListAllOf {
    /**
     * The unique numeric ID of the `Price List`; increments sequentially.
     * @type {number}
     * @memberof PriceListAllOf
     */
    id?: number;
    /**
...
export function PriceListAllOfFromJSON(json: any): PriceListAllOf {
    return PriceListAllOfFromJSONTyped(json, false);
}

export function PriceListAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): PriceListAllOf {
...
export function PriceListAllOfToJSON(value?: PriceListAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
