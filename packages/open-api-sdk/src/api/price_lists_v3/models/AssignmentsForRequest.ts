 ...
 * @export
 * @interface AssignmentsForRequest
 */
export interface AssignmentsForRequest {
    /**
     * Customer group id for assignment.
     * @type {number}
     * @memberof AssignmentsForRequest
     */
...
export function AssignmentsForRequestFromJSON(json: any): AssignmentsForRequest {
    return AssignmentsForRequestFromJSONTyped(json, false);
}

export function AssignmentsForRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssignmentsForRequest {
...
export function AssignmentsForRequestToJSON(value?: AssignmentsForRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
