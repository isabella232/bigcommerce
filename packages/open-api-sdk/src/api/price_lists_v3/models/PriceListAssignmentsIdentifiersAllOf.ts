 ...
 * 
 * @export
 * @interface PriceListAssignmentsIdentifiersAllOf
 */
export interface PriceListAssignmentsIdentifiersAllOf {
    /**
     ...
     * @type {number}
     * @memberof PriceListAssignmentsIdentifiersAllOf
     */
...
export function PriceListAssignmentsIdentifiersAllOfFromJSON(json: any): PriceListAssignmentsIdentifiersAllOf {
    return PriceListAssignmentsIdentifiersAllOfFromJSONTyped(json, false);
}

export function PriceListAssignmentsIdentifiersAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): PriceListAssignmentsIdentifiersAllOf {
...
export function PriceListAssignmentsIdentifiersAllOfToJSON(value?: PriceListAssignmentsIdentifiersAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
