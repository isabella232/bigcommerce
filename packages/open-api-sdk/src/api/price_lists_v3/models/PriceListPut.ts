 ...
 * Update a PriceList
 * @export
 * @interface PriceListPut
 */
export interface PriceListPut {
    /**
     * The unique name of the Price List. Required in /POST. 
     * @type {string}
     * @memberof PriceListPut
     */
    name: string;
    /**
...
export function PriceListPutFromJSON(json: any): PriceListPut {
    return PriceListPutFromJSONTyped(json, false);
}

export function PriceListPutFromJSONTyped(json: any, ignoreDiscriminator: boolean): PriceListPut {
...
export function PriceListPutToJSON(value?: PriceListPut | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
