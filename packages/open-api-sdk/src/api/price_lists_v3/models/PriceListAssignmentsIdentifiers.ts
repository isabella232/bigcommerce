...
import {
    PriceListAssignmentsIdentifiersAllOf,
    PriceListAssignmentsIdentifiersAllOfFromJSON,
    PriceListAssignmentsIdentifiersAllOfFromJSONTyped,
    PriceListAssignmentsIdentifiersAllOfToJSON,
} from './';

/**
 * `Price List Assignments` object used in GET response.
 * @export
 * @interface PriceListAssignmentsIdentifiers
 */
export interface PriceListAssignmentsIdentifiers {
    /**
     ...
     * @type {number}
     * @memberof PriceListAssignmentsIdentifiers
     */
...
export function PriceListAssignmentsIdentifiersFromJSON(json: any): PriceListAssignmentsIdentifiers {
    return PriceListAssignmentsIdentifiersFromJSONTyped(json, false);
}

export function PriceListAssignmentsIdentifiersFromJSONTyped(json: any, ignoreDiscriminator: boolean): PriceListAssignmentsIdentifiers {
...
export function PriceListAssignmentsIdentifiersToJSON(value?: PriceListAssignmentsIdentifiers | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
