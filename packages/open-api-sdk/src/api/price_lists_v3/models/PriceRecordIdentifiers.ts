...
import {
    PriceRecordIdentifiersAllOf,
    PriceRecordIdentifiersAllOfFromJSON,
    PriceRecordIdentifiersAllOfFromJSONTyped,
    PriceRecordIdentifiersAllOfToJSON,
} from './';

/**
 * Price Record object used in batch create or update.
 * @export
 * @interface PriceRecordIdentifiers
 */
export interface PriceRecordIdentifiers {
    /**
     * The Price List with which this price set is associated.
     * @type {number}
     * @memberof PriceRecordIdentifiers
     */
    priceListId?: number;
    /**
...
export function PriceRecordIdentifiersFromJSON(json: any): PriceRecordIdentifiers {
    return PriceRecordIdentifiersFromJSONTyped(json, false);
}

export function PriceRecordIdentifiersFromJSONTyped(json: any, ignoreDiscriminator: boolean): PriceRecordIdentifiers {
...
export function PriceRecordIdentifiersToJSON(value?: PriceRecordIdentifiers | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
