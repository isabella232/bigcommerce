 ...
 * @export
 * @interface PriceRecordCollectionResponse
 */
export interface PriceRecordCollectionResponse {
    /**
     * 
     * @type {Array<object>}
     * @memberof PriceRecordCollectionResponse
     */
    data?: Array<object>;
    /**
     * 
...
export function PriceRecordCollectionResponseFromJSON(json: any): PriceRecordCollectionResponse {
    return PriceRecordCollectionResponseFromJSONTyped(json, false);
}

export function PriceRecordCollectionResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PriceRecordCollectionResponse {
...
export function PriceRecordCollectionResponseToJSON(value?: PriceRecordCollectionResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
