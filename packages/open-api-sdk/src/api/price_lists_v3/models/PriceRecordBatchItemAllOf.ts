 ...
 * 
 * @export
 * @interface PriceRecordBatchItemAllOf
 */
export interface PriceRecordBatchItemAllOf {
    /**
     * The variant with which this price set is associated. Either variant_id or sku is required.
     * @type {number}
     * @memberof PriceRecordBatchItemAllOf
     */
    variantId?: number;
    /**
...
export function PriceRecordBatchItemAllOfFromJSON(json: any): PriceRecordBatchItemAllOf {
    return PriceRecordBatchItemAllOfFromJSONTyped(json, false);
}

export function PriceRecordBatchItemAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): PriceRecordBatchItemAllOf {
...
export function PriceRecordBatchItemAllOfToJSON(value?: PriceRecordBatchItemAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
