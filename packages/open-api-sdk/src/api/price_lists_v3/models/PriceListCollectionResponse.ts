 ...
 * Get All PriceLists.
 * @export
 * @interface PriceListCollectionResponse
 */
export interface PriceListCollectionResponse {
    /**
     * 
     * @type {Array<object>}
     * @memberof PriceListCollectionResponse
     */
    data?: Array<object>;
    /**
     * 
...
export function PriceListCollectionResponseFromJSON(json: any): PriceListCollectionResponse {
    return PriceListCollectionResponseFromJSONTyped(json, false);
}

export function PriceListCollectionResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PriceListCollectionResponse {
...
export function PriceListCollectionResponseToJSON(value?: PriceListCollectionResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
