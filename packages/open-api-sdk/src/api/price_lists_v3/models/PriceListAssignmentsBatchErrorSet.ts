...
import {
    ...
    PriceListAssignmentsIdentifiersFromJSON,
    PriceListAssignmentsIdentifiersFromJSONTyped,
    PriceListAssignmentsIdentifiersToJSON,
} from './';

/**
 * Error during `Price List Assignments` batch POST. Includes data sent in the request and errors.
 * @export
 * @interface PriceListAssignmentsBatchErrorSet
 */
export interface PriceListAssignmentsBatchErrorSet {
    /**
     * 
     * @type {PriceListAssignmentsIdentifiers}
     * @memberof PriceListAssignmentsBatchErrorSet
     */
    data?: PriceListAssignmentsIdentifiers;
    /**
     * 
...
export function PriceListAssignmentsBatchErrorSetFromJSON(json: any): PriceListAssignmentsBatchErrorSet {
    return PriceListAssignmentsBatchErrorSetFromJSONTyped(json, false);
}

export function PriceListAssignmentsBatchErrorSetFromJSONTyped(json: any, ignoreDiscriminator: boolean): PriceListAssignmentsBatchErrorSet {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'data': !exists(json, 'data') ? undefined : PriceListAssignmentsIdentifiersFromJSON(json['data']),
        'fieldErrors': !exists(json, 'field_errors') ? undefined : json['field_errors'],
    };
}

export function PriceListAssignmentsBatchErrorSetToJSON(value?: PriceListAssignmentsBatchErrorSet | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'data': PriceListAssignmentsIdentifiersToJSON(value.data),
