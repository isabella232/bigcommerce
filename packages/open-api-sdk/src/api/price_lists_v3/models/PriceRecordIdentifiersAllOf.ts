 ...
 * 
 * @export
 * @interface PriceRecordIdentifiersAllOf
 */
export interface PriceRecordIdentifiersAllOf {
    /**
     * The Price List with which this price set is associated.
     * @type {number}
     * @memberof PriceRecordIdentifiersAllOf
     */
    priceListId?: number;
    /**
...
export function PriceRecordIdentifiersAllOfFromJSON(json: any): PriceRecordIdentifiersAllOf {
    return PriceRecordIdentifiersAllOfFromJSONTyped(json, false);
}

export function PriceRecordIdentifiersAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): PriceRecordIdentifiersAllOf {
...
export function PriceRecordIdentifiersAllOfToJSON(value?: PriceRecordIdentifiersAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
