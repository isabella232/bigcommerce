...
export function PriceRecordResponseFromJSON(json: any): PriceRecordResponse {
    return PriceRecordResponseFromJSONTyped(json, false);
}

export function PriceRecordResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PriceRecordResponse {
...
export function PriceRecordResponseToJSON(value?: PriceRecordResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
