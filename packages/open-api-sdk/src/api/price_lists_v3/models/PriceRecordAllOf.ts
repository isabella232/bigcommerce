 ...
 * 
 * @export
 * @interface PriceRecordAllOf
 */
export interface PriceRecordAllOf {
    /**
...
export function PriceRecordAllOfFromJSON(json: any): PriceRecordAllOf {
    return PriceRecordAllOfFromJSONTyped(json, false);
}

export function PriceRecordAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): PriceRecordAllOf {
...
export function PriceRecordAllOfToJSON(value?: PriceRecordAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
