...
export function PriceRecordBaseFromJSON(json: any): PriceRecordBase {
    return PriceRecordBaseFromJSONTyped(json, false);
}

export function PriceRecordBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PriceRecordBase {
...
export function PriceRecordBaseToJSON(value?: PriceRecordBase | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
