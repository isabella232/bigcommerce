 ...
 * 
 * @export
 * @interface PriceRecordPut
 */
export interface PriceRecordPut {
    /**
...
export function PriceRecordPutFromJSON(json: any): PriceRecordPut {
    return PriceRecordPutFromJSONTyped(json, false);
}

export function PriceRecordPutFromJSONTyped(json: any, ignoreDiscriminator: boolean): PriceRecordPut {
...
export function PriceRecordPutToJSON(value?: PriceRecordPut | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
