 ...
 * 
 * @export
 * @interface AssignmentForGetResponse
 */
export interface AssignmentForGetResponse {
    /**
     * Unique identifier for this price list assignment.
     * @type {number}
     * @memberof AssignmentForGetResponse
     */
    id?: number;
    /**
...
export function AssignmentForGetResponseFromJSON(json: any): AssignmentForGetResponse {
    return AssignmentForGetResponseFromJSONTyped(json, false);
}

export function AssignmentForGetResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssignmentForGetResponse {
...
export function AssignmentForGetResponseToJSON(value?: AssignmentForGetResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
