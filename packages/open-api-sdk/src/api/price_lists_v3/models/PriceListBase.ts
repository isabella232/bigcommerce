...
export function PriceListBaseFromJSON(json: any): PriceListBase {
    return PriceListBaseFromJSONTyped(json, false);
}

export function PriceListBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PriceListBase {
...
export function PriceListBaseToJSON(value?: PriceListBase | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
