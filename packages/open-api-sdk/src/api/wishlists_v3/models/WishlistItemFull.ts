...
export function WishlistItemFullFromJSON(json: any): WishlistItemFull {
    return WishlistItemFullFromJSONTyped(json, false);
}

export function WishlistItemFullFromJSONTyped(json: any, ignoreDiscriminator: boolean): WishlistItemFull {
...
export function WishlistItemFullToJSON(value?: WishlistItemFull | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
