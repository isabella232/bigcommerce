...
export function ScriptResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScriptResponse {
    ...
    return {
        ...
        'data': !exists(json, 'data') ? undefined : ScriptFullFromJSON(json['data']),
        'meta': !exists(json, 'meta') ? undefined : json['meta'],
    };
}

export function ScriptResponseToJSON(value?: ScriptResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'data': ScriptFullToJSON(value.data),
        'meta': value.meta,
    };
}
