...
import {
    ...
    ScriptBaseToJSON,
    ScriptPostAllOf,
    ScriptPostAllOfFromJSON,
    ScriptPostAllOfFromJSONTyped,
    ScriptPostAllOfToJSON,
} from './';
...
export interface ScriptPost {
     ...
     * @memberof ScriptPost
     */
    loadMethod?: ScriptPostLoadMethodEnum;
    /**
     ...
     * @memberof ScriptPost
     */
    consentCategory?: ScriptPostConsentCategoryEnum;
    /**
...
* @enum {string}
*/
export enum ScriptPostLoadMethodEnum {
    Default = 'default',
    Async = 'async',
    Defer = 'defer'
}/**
...
* @enum {string}
*/
export enum ScriptPostLocationEnum {
    Head = 'head',
    Footer = 'footer'
}/**
* @export
* @enum {string}
*/
export enum ScriptPostVisibilityEnum {
...
* @enum {string}
*/
export enum ScriptPostKindEnum {
    Src = 'src',
...
* @enum {string}
*/
export enum ScriptPostConsentCategoryEnum {
    Essential = 'essential',
...
export function ScriptPostFromJSON(json: any): ScriptPost {
    return ScriptPostFromJSONTyped(json, false);
}

export function ScriptPostFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScriptPost {
...
export function ScriptPostToJSON(value?: ScriptPost | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
