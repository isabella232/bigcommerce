 ...
 * 
 * @export
 * @interface ScriptPostAllOf
 */
export interface ScriptPostAllOf {
    /**
     * The user-friendly name.
     * @type {string}
     * @memberof ScriptPostAllOf
     */
    name: string;
}

export function ScriptPostAllOfFromJSON(json: any): ScriptPostAllOf {
    return ScriptPostAllOfFromJSONTyped(json, false);
}

export function ScriptPostAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScriptPostAllOf {
...
export function ScriptPostAllOfToJSON(value?: ScriptPostAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
