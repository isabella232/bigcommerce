 ...
 * @export
 * @interface BaseRateRequest
 */
export interface BaseRateRequest {
    /**
     * 
     * @type {ShippingAddress}
     * @memberof BaseRateRequest
     */
...
export function BaseRateRequestFromJSON(json: any): BaseRateRequest {
    return BaseRateRequestFromJSONTyped(json, false);
}

export function BaseRateRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): BaseRateRequest {
...
export function BaseRateRequestToJSON(value?: BaseRateRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
