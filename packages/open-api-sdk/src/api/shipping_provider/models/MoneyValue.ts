...
export function MoneyValueFromJSON(json: any): MoneyValue {
    return MoneyValueFromJSONTyped(json, false);
}

export function MoneyValueFromJSONTyped(json: any, ignoreDiscriminator: boolean): MoneyValue {
...
export function MoneyValueToJSON(value?: MoneyValue | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
