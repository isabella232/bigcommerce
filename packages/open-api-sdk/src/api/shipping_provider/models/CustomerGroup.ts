...
export function CustomerGroupFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomerGroup {
    ...
    return {
        ...
        'customerGroupName': !exists(json, 'customer_group_name') ? undefined : json['customer_group_name'],
    };
}

export function CustomerGroupToJSON(value?: CustomerGroup | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'customer_group_name': value.customerGroupName,
    };
}
