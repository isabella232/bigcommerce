...
export function RateRequestPayloadFromJSON(json: any): RateRequestPayload {
    return RateRequestPayloadFromJSONTyped(json, false);
}

export function RateRequestPayloadFromJSONTyped(json: any, ignoreDiscriminator: boolean): RateRequestPayload {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'baseOptions': BaseOptionsFromJSON(json['base_options']),
...
export function RateRequestPayloadToJSON(value?: RateRequestPayload | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'base_options': BaseOptionsToJSON(value.baseOptions),
