 ...
 * @export
 * @interface InlineResponse200PriceRange
 */
export interface InlineResponse200PriceRange {
    /**
     * 
     * @type {InlineResponse200SalePrice}
     * @memberof InlineResponse200PriceRange
     */
...
export function InlineResponse200PriceRangeFromJSON(json: any): InlineResponse200PriceRange {
    return InlineResponse200PriceRangeFromJSONTyped(json, false);
}

export function InlineResponse200PriceRangeFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse200PriceRange {
...
export function InlineResponse200PriceRangeToJSON(value?: InlineResponse200PriceRange | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
