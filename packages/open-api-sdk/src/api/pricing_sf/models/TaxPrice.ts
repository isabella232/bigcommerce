...
export function TaxPriceFromJSON(json: any): TaxPrice {
    return TaxPriceFromJSONTyped(json, false);
}

export function TaxPriceFromJSONTyped(json: any, ignoreDiscriminator: boolean): TaxPrice {
...
export function TaxPriceToJSON(value?: TaxPrice | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
