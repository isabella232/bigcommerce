...
export interface CreateTokenWithCustomerImpersonationRequest {
    xBcCustomerId: number;
 ...
 * 
 */
export class CustomerImpersonationTokenApi extends runtime.BaseAPI {

    /**
     * Creates a Storefront API token that allows for customer impersonation.  **Required Scopes** * `Manage` `Storefront API Customer Impersonation Tokens`  **Headers**: * `X-Bc-Customer-Id` - The ID of the Customer to impersonate
     * Create a Token
     */
    async createTokenWithCustomerImpersonationRaw(requestParameters: CreateTokenWithCustomerImpersonationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<TokenFull>> {
        if (requestParameters.xBcCustomerId === null || requestParameters.xBcCustomerId === undefined) {
            throw new runtime.RequiredError('xBcCustomerId','Required parameter requestParameters.xBcCustomerId was null or undefined when calling createTokenWithCustomerImpersonation.');
        }
        ...
        if (requestParameters.xBcCustomerId !== undefined && requestParameters.xBcCustomerId !== null) {
            headerParameters['X-Bc-Customer-Id'] = String(requestParameters.xBcCustomerId);
        }
        ...
        const response = await this.request({
            ...
            body: TokenPostImpersonationToJSON(requestParameters.body),
        }, initOverrides);
     ...
     * Create a Token
     */
    async createTokenWithCustomerImpersonation(requestParameters: CreateTokenWithCustomerImpersonationRequest, initOverrides?: RequestInit): Promise<TokenFull> {
        const response = await this.createTokenWithCustomerImpersonationRaw(requestParameters, initOverrides);
