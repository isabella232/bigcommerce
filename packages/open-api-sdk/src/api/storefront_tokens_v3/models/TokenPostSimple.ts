 ...
 * 
 * @export
 * @interface TokenPostSimple
 */
export interface TokenPostSimple {
    /**
     * List of allowed domains for Cross-Origin Request Sharing. Currently only accepts a single element.
     * @type {Array<string>}
     * @memberof TokenPostSimple
     */
    allowedCorsOrigins?: Array<string>;
}

export function TokenPostSimpleFromJSON(json: any): TokenPostSimple {
    return TokenPostSimpleFromJSONTyped(json, false);
}

export function TokenPostSimpleFromJSONTyped(json: any, ignoreDiscriminator: boolean): TokenPostSimple {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'allowedCorsOrigins': !exists(json, 'allowed_cors_origins') ? undefined : json['allowed_cors_origins'],
    };
}

export function TokenPostSimpleToJSON(value?: TokenPostSimple | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'allowed_cors_origins': value.allowedCorsOrigins,
    };
}
