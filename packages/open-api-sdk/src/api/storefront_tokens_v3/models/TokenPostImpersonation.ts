 ...
 * 
 * @export
 * @interface TokenPostImpersonation
 */
export interface TokenPostImpersonation {
    /**
     * Channel ID for requested token
     * @type {number}
     * @memberof TokenPostImpersonation
     */
    channelId: number;
    /**
...
export function TokenPostImpersonationFromJSON(json: any): TokenPostImpersonation {
    return TokenPostImpersonationFromJSONTyped(json, false);
}

export function TokenPostImpersonationFromJSONTyped(json: any, ignoreDiscriminator: boolean): TokenPostImpersonation {
...
export function TokenPostImpersonationToJSON(value?: TokenPostImpersonation | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
