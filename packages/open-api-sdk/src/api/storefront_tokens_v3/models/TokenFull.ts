...
export function TokenFullFromJSON(json: any): TokenFull {
    return TokenFullFromJSONTyped(json, false);
}

export function TokenFullFromJSONTyped(json: any, ignoreDiscriminator: boolean): TokenFull {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'data': !exists(json, 'data') ? undefined : TokenBaseFromJSON(json['data']),
        'meta': !exists(json, 'meta') ? undefined : json['meta'],
    };
}

export function TokenFullToJSON(value?: TokenFull | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'data': TokenBaseToJSON(value.data),
        'meta': value.meta,
    };
}
