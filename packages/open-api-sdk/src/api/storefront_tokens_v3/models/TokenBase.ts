...
export function TokenBaseFromJSON(json: any): TokenBase {
    return TokenBaseFromJSONTyped(json, false);
}

export function TokenBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TokenBase {
...
export function TokenBaseToJSON(value?: TokenBase | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
