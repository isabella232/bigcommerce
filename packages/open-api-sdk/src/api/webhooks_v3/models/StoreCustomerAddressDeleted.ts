 ...
 * ### Callback schema:
 * @export
 * @interface StoreCustomerAddressDeleted
 */
export interface StoreCustomerAddressDeleted {
    /**
     * Hook creation date as a Unix timestamp.
     * @type {number}
     * @memberof StoreCustomerAddressDeleted
     */
...
export function StoreCustomerAddressDeletedFromJSON(json: any): StoreCustomerAddressDeleted {
    return StoreCustomerAddressDeletedFromJSONTyped(json, false);
}

export function StoreCustomerAddressDeletedFromJSONTyped(json: any, ignoreDiscriminator: boolean): StoreCustomerAddressDeleted {
...
export function StoreCustomerAddressDeletedToJSON(value?: StoreCustomerAddressDeleted | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
