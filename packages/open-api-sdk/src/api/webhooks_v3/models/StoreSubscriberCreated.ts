 ...
 * ### Callback schema:
 * @export
 * @interface StoreSubscriberCreated
 */
export interface StoreSubscriberCreated {
    /**
     * Hook creation date as a Unix timestamp.
     * @type {number}
     * @memberof StoreSubscriberCreated
     */
...
export function StoreSubscriberCreatedFromJSON(json: any): StoreSubscriberCreated {
    return StoreSubscriberCreatedFromJSONTyped(json, false);
}

export function StoreSubscriberCreatedFromJSONTyped(json: any, ignoreDiscriminator: boolean): StoreSubscriberCreated {
...
export function StoreSubscriberCreatedToJSON(value?: StoreSubscriberCreated | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
