 ...
 * ### Callback schema:
 * @export
 * @interface StoreCartLineItemDeleted
 */
export interface StoreCartLineItemDeleted {
    /**
     * Hook creation date as a Unix timestamp.
     * @type {number}
     * @memberof StoreCartLineItemDeleted
     */
...
export function StoreCartLineItemDeletedFromJSON(json: any): StoreCartLineItemDeleted {
    return StoreCartLineItemDeletedFromJSONTyped(json, false);
}

export function StoreCartLineItemDeletedFromJSONTyped(json: any, ignoreDiscriminator: boolean): StoreCartLineItemDeleted {
...
export function StoreCartLineItemDeletedToJSON(value?: StoreCartLineItemDeleted | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
