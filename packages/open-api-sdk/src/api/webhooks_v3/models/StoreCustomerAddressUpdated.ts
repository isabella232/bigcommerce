 ...
 * ### Callback schema:
 * @export
 * @interface StoreCustomerAddressUpdated
 */
export interface StoreCustomerAddressUpdated {
    /**
     * Hook creation date as a Unix timestamp.
     * @type {number}
     * @memberof StoreCustomerAddressUpdated
     */
...
export function StoreCustomerAddressUpdatedFromJSON(json: any): StoreCustomerAddressUpdated {
    return StoreCustomerAddressUpdatedFromJSONTyped(json, false);
}

export function StoreCustomerAddressUpdatedFromJSONTyped(json: any, ignoreDiscriminator: boolean): StoreCustomerAddressUpdated {
...
export function StoreCustomerAddressUpdatedToJSON(value?: StoreCustomerAddressUpdated | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
