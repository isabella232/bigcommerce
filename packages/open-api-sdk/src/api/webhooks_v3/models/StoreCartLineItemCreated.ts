 ...
 * ### Callback schema:
 * @export
 * @interface StoreCartLineItemCreated
 */
export interface StoreCartLineItemCreated {
    /**
     * Hook creation date as a Unix timestamp.
     * @type {number}
     * @memberof StoreCartLineItemCreated
     */
...
export function StoreCartLineItemCreatedFromJSON(json: any): StoreCartLineItemCreated {
    return StoreCartLineItemCreatedFromJSONTyped(json, false);
}

export function StoreCartLineItemCreatedFromJSONTyped(json: any, ignoreDiscriminator: boolean): StoreCartLineItemCreated {
...
export function StoreCartLineItemCreatedToJSON(value?: StoreCartLineItemCreated | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
