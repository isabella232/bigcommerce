 ...
 * ### Callback schema:
 * @export
 * @interface StoreChannelCreated
 */
export interface StoreChannelCreated {
    /**
     * Hook creation date as a Unix timestamp.
     * @type {number}
     * @memberof StoreChannelCreated
     */
...
export function StoreChannelCreatedFromJSON(json: any): StoreChannelCreated {
    return StoreChannelCreatedFromJSONTyped(json, false);
}

export function StoreChannelCreatedFromJSONTyped(json: any, ignoreDiscriminator: boolean): StoreChannelCreated {
...
export function StoreChannelCreatedToJSON(value?: StoreChannelCreated | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
