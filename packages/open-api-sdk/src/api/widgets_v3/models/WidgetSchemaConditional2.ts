 ...
 * @export
 * @interface WidgetSchemaConditional2
 */
export interface WidgetSchemaConditional2 {
    /**
     * The ID of the `setting` object the conditional attribute is related to.
     * @type {string}
     * @memberof WidgetSchemaConditional2
     */
    key?: string;
    /**
...
export function WidgetSchemaConditional2FromJSON(json: any): WidgetSchemaConditional2 {
    return WidgetSchemaConditional2FromJSONTyped(json, false);
}

export function WidgetSchemaConditional2FromJSONTyped(json: any, ignoreDiscriminator: boolean): WidgetSchemaConditional2 {
...
export function WidgetSchemaConditional2ToJSON(value?: WidgetSchemaConditional2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
