 ...
 * 
 * @export
 * @interface WidgetTemplatePost
 */
export interface WidgetTemplatePost {
    /**
     * User-friendly name.
     * @type {string}
     * @memberof WidgetTemplatePost
     */
    name: string;
    /**
...
export function WidgetTemplatePostFromJSON(json: any): WidgetTemplatePost {
    return WidgetTemplatePostFromJSONTyped(json, false);
}

export function WidgetTemplatePostFromJSONTyped(json: any, ignoreDiscriminator: boolean): WidgetTemplatePost {
...
export function WidgetTemplatePostToJSON(value?: WidgetTemplatePost | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
