 ...
 * @enum {string}
 */
export enum WidgetSchemaTab {
    Tab = 'tab'
}

export function WidgetSchemaTabFromJSON(json: any): WidgetSchemaTab {
    return WidgetSchemaTabFromJSONTyped(json, false);
}

export function WidgetSchemaTabFromJSONTyped(json: any, ignoreDiscriminator: boolean): WidgetSchemaTab {
    return json as WidgetSchemaTab;
}

export function WidgetSchemaTabToJSON(value?: WidgetSchemaTab | null): any {
    return value as any;
}
