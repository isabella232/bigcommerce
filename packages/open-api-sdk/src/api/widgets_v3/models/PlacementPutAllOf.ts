 ...
 * 
 * @export
 * @interface PlacementPutAllOf
 */
export interface PlacementPutAllOf {
    /**
     * The template file that you would like to target.
     * @type {string}
     * @memberof PlacementPutAllOf
     */
    templateFile?: string;
    /**
     * A widget identifier.
...
export function PlacementPutAllOfFromJSON(json: any): PlacementPutAllOf {
    return PlacementPutAllOfFromJSONTyped(json, false);
}

export function PlacementPutAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlacementPutAllOf {
...
export function PlacementPutAllOfToJSON(value?: PlacementPutAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
