 ...
 * 
 * @export
 * @interface PlacementPostAllOf
 */
export interface PlacementPostAllOf {
    /**
     * A widget identifier.
     * @type {string}
     * @memberof PlacementPostAllOf
     */
    widgetUuid: string;
    /**
...
export function PlacementPostAllOfFromJSON(json: any): PlacementPostAllOf {
    return PlacementPostAllOfFromJSONTyped(json, false);
}

export function PlacementPostAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlacementPostAllOf {
...
export function PlacementPostAllOfToJSON(value?: PlacementPostAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
