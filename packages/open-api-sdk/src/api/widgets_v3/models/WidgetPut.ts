...
import {
    ...
    WidgetBaseToJSON,
    WidgetPutAllOf,
    WidgetPutAllOfFromJSON,
    WidgetPutAllOfFromJSONTyped,
    WidgetPutAllOfToJSON,
} from './';
...
export function WidgetPutFromJSON(json: any): WidgetPut {
    return WidgetPutFromJSONTyped(json, false);
}

export function WidgetPutFromJSONTyped(json: any, ignoreDiscriminator: boolean): WidgetPut {
...
export function WidgetPutToJSON(value?: WidgetPut | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
