...
import {
    ...
    WidgetSchemaTabTypeMetaSelectOptionsFromJSON,
    WidgetSchemaTabTypeMetaSelectOptionsFromJSONTyped,
    WidgetSchemaTabTypeMetaSelectOptionsToJSON,
} from './';

/**
 * Additional information needed based on the selected setting type.
 * @export
 * @interface WidgetSchemaTabTypeMeta
 */
export interface WidgetSchemaTabTypeMeta {
    /**
     * 
     * @type {Array<WidgetSchemaTabTypeMetaSelectOptions>}
     * @memberof WidgetSchemaTabTypeMeta
     */
    selectOptions?: Array<WidgetSchemaTabTypeMetaSelectOptions>;
}

export function WidgetSchemaTabTypeMetaFromJSON(json: any): WidgetSchemaTabTypeMeta {
    return WidgetSchemaTabTypeMetaFromJSONTyped(json, false);
}

export function WidgetSchemaTabTypeMetaFromJSONTyped(json: any, ignoreDiscriminator: boolean): WidgetSchemaTabTypeMeta {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'selectOptions': !exists(json, 'selectOptions') ? undefined : ((json['selectOptions'] as Array<any>).map(WidgetSchemaTabTypeMetaSelectOptionsFromJSON)),
    };
}

export function WidgetSchemaTabTypeMetaToJSON(value?: WidgetSchemaTabTypeMeta | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'selectOptions': value.selectOptions === undefined ? undefined : ((value.selectOptions as Array<any>).map(WidgetSchemaTabTypeMetaSelectOptionsToJSON)),
    };
}
