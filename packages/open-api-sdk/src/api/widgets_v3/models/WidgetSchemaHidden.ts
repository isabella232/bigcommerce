 ...
 * @enum {string}
 */
export enum WidgetSchemaHidden {
    Hidden = 'hidden'
}

export function WidgetSchemaHiddenFromJSON(json: any): WidgetSchemaHidden {
    return WidgetSchemaHiddenFromJSONTyped(json, false);
}

export function WidgetSchemaHiddenFromJSONTyped(json: any, ignoreDiscriminator: boolean): WidgetSchemaHidden {
    return json as WidgetSchemaHidden;
}

export function WidgetSchemaHiddenToJSON(value?: WidgetSchemaHidden | null): any {
    return value as any;
}
