 ...
 * @export
 * @interface WidgetSchemaConditional
 */
export interface WidgetSchemaConditional {
    /**
     * The ID of the `setting` object the conditional attribute is related to.
     * @type {string}
     * @memberof WidgetSchemaConditional
     */
    key?: string;
    /**
...
export function WidgetSchemaConditionalFromJSON(json: any): WidgetSchemaConditional {
    return WidgetSchemaConditionalFromJSONTyped(json, false);
}

export function WidgetSchemaConditionalFromJSONTyped(json: any, ignoreDiscriminator: boolean): WidgetSchemaConditional {
...
export function WidgetSchemaConditionalToJSON(value?: WidgetSchemaConditional | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
