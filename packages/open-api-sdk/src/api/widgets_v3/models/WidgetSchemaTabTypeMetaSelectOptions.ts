 ...
 * 
 * @export
 * @interface WidgetSchemaTabTypeMetaSelectOptions
 */
export interface WidgetSchemaTabTypeMetaSelectOptions {
    /**
     * 
     * @type {string}
     * @memberof WidgetSchemaTabTypeMetaSelectOptions
     */
    label?: string;
    /**
     * 
...
export function WidgetSchemaTabTypeMetaSelectOptionsFromJSON(json: any): WidgetSchemaTabTypeMetaSelectOptions {
    return WidgetSchemaTabTypeMetaSelectOptionsFromJSONTyped(json, false);
}

export function WidgetSchemaTabTypeMetaSelectOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): WidgetSchemaTabTypeMetaSelectOptions {
...
export function WidgetSchemaTabTypeMetaSelectOptionsToJSON(value?: WidgetSchemaTabTypeMetaSelectOptions | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
