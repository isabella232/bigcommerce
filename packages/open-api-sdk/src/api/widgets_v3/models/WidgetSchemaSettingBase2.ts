...
import {
    WidgetSchemaConditional2,
    WidgetSchemaConditional2FromJSON,
    WidgetSchemaConditional2FromJSONTyped,
    WidgetSchemaConditional2ToJSON,
 ...
 * @export
 * @interface WidgetSchemaSettingBase2
 */
export interface WidgetSchemaSettingBase2 {
    /**
     * The type of setting component to display. You can view the list of elements below to discover which are available to use.
     * 
     * For examples of each type of setting, see [Page Builder > Schema Settings](https://developer.bigcommerce.com/stencil-docs/page-builder/schema-settings/alignment) in Theme Docs.
     * @type {string}
     * @memberof WidgetSchemaSettingBase2
     */
    type?: WidgetSchemaSettingBase2TypeEnum;
    /**
    ...
    /**
     * 
     * @type {WidgetSchemaConditional2}
     * @memberof WidgetSchemaSettingBase2
     */
    conditional?: WidgetSchemaConditional2;
}
...
* @enum {string}
*/
export enum WidgetSchemaSettingBase2TypeEnum {
    Alignment = 'alignment',
    Boolean = 'boolean',
    BoxModel = 'boxModel',
    Code = 'code',
...
export function WidgetSchemaSettingBase2FromJSON(json: any): WidgetSchemaSettingBase2 {
    return WidgetSchemaSettingBase2FromJSONTyped(json, false);
}

export function WidgetSchemaSettingBase2FromJSONTyped(json: any, ignoreDiscriminator: boolean): WidgetSchemaSettingBase2 {
    ...
    return {
        ...
        'conditional': !exists(json, 'conditional') ? undefined : WidgetSchemaConditional2FromJSON(json['conditional']),
    };
}

export function WidgetSchemaSettingBase2ToJSON(value?: WidgetSchemaSettingBase2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'conditional': WidgetSchemaConditional2ToJSON(value.conditional),
    };
}
