 ...
 * 
 * @export
 * @interface WidgetTemplatePutAllOf
 */
export interface WidgetTemplatePutAllOf {
    /**
     * Can be added to create a new widget template version instead of updating the current one.
     * @type {boolean}
     * @memberof WidgetTemplatePutAllOf
     */
    createNewVersion?: boolean;
}

export function WidgetTemplatePutAllOfFromJSON(json: any): WidgetTemplatePutAllOf {
    return WidgetTemplatePutAllOfFromJSONTyped(json, false);
}

export function WidgetTemplatePutAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): WidgetTemplatePutAllOf {
...
export function WidgetTemplatePutAllOfToJSON(value?: WidgetTemplatePutAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
