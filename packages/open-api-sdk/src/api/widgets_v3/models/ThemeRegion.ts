...
export interface ThemeRegion {
     ...
     * The region name.
     * @type {string}
     * @memberof ThemeRegion
     */
    name?: string;
}

export function ThemeRegionFromJSON(json: any): ThemeRegion {
    return ThemeRegionFromJSONTyped(json, false);
}

export function ThemeRegionFromJSONTyped(json: any, ignoreDiscriminator: boolean): ThemeRegion {
...
export function ThemeRegionToJSON(value?: ThemeRegion | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
