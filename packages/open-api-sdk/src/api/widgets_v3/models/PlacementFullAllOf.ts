 ...
 * 
 * @export
 * @interface PlacementFullAllOf
 */
export interface PlacementFullAllOf {
    /**
     * The primary identifier.
     * @type {string}
     * @memberof PlacementFullAllOf
     */
    uuid?: string;
    /**
...
export function PlacementFullAllOfFromJSON(json: any): PlacementFullAllOf {
    return PlacementFullAllOfFromJSONTyped(json, false);
}

export function PlacementFullAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlacementFullAllOf {
...
export function PlacementFullAllOfToJSON(value?: PlacementFullAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
