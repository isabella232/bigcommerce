 ...
 * @export
 * @interface WidgetSchemaArrayThumbnail
 */
export interface WidgetSchemaArrayThumbnail {
    /**
     * 
     * @type {string}
     * @memberof WidgetSchemaArrayThumbnail
     */
    type?: string;
    /**
     * 
...
export function WidgetSchemaArrayThumbnailFromJSON(json: any): WidgetSchemaArrayThumbnail {
    return WidgetSchemaArrayThumbnailFromJSONTyped(json, false);
}

export function WidgetSchemaArrayThumbnailFromJSONTyped(json: any, ignoreDiscriminator: boolean): WidgetSchemaArrayThumbnail {
    ...
    return {
        ...
        'valueKey': !exists(json, 'valueKey') ? undefined : json['valueKey'],
    };
}

export function WidgetSchemaArrayThumbnailToJSON(value?: WidgetSchemaArrayThumbnail | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
