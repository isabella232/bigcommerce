...
export function SubscriberPostFromJSON(json: any): SubscriberPost {
    return SubscriberPostFromJSONTyped(json, false);
}

export function SubscriberPostFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubscriberPost {
...
export function SubscriberPostToJSON(value?: SubscriberPost | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
