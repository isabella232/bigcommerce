...
export function SubscriberBaseFromJSON(json: any): SubscriberBase {
    return SubscriberBaseFromJSONTyped(json, false);
}

export function SubscriberBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubscriberBase {
...
export function SubscriberBaseToJSON(value?: SubscriberBase | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
